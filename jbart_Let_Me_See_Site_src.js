...
function aa_youtube_video(youtubeVideo,settings) {
	...
	var iframe = $('<iframe frameborder="0" allowfullscreen="true" />').attr('src','//www.youtube.com/embed/'+youtubeVideo.key);
	
	youtubeVideo.el.appendChild(iframe[0]);
}
		...
		function onresize() {
			...
			if (ajaxart.window_size.width == window.innerWidth &&
			 ...
			 aa_windowresize = setTimeout(function() {
				$("body").find(".aa_window_resize_listener").each(function(i,elem) { jBart.trigger(elem,'WindowResize'); });
				 aa_windowresize = 0;
		 	}, 100);
		}
...
function aa_field_setAsyncActionBeforeLoad(topSettings) {
	topSettings.field.AsyncActionRunner = function(settings) {
		...
		aa_renderStyleObject(topSettings.loadingStyle, loadingObject, settings.Context, true);
...
{
	window.aa_delayed_actions = window.aa_delayed_actions || {};
	if (aa_delayed_actions[action_id])
		clearTimeout(aa_delayed_actions[action_id]);

	aa_delayed_actions[action_id] = setTimeout(function() {
...
function aa_JSON2Xml(obj,tag,result)
{
	...
	function json2Xml(obj,result,depth)
	{
		...
		if (depth == 20) { ; return result.ownerDocument.createElement('TooMuchRecursion'); }
		...
		aa_bind(field,'ModifyInstanceContext',function(args) {
			var visualCntr = {
				...
				init: function(top) {
					...
					$(top).addClass('aa_visual_container').css('position','relative');				
					if (this.width) {
				...
				scrollY: function() {
					return this.originalHeight ? this.el.scrollTop : window.pageYOffset;
				},
				scrollTop: function(y) {
					this.originalHeight ? $(this.el).scrollTop(y) : $(window).scrollTop(y);
				},
				absTop: function() {
...
ItemList:function (profile, data, context) 
    {
        ...
        field.Control = function (data1, ctx) {
            ...
            itemlist.el.jbApiObject = itemlist;
...
ajaxart.load_xtml_content('',ajaxart.parsexml('<xtml package="true"><xtml ns="youtube_style"><Component id="Default" type="youtube.Style"><Param name="Width" slider="true" sliderUnit="px" Default="420px"/><Param name="Height" slider="true" sliderUnit="px" Default="315px"/><xtml t="ui.CustomStyle"><Html><![CDATA[<div />]]></Html><Css><![CDATA[iframe {\r\n  width: %$Width%;\t      \r\n  height: %$Height%;\t      \r\n}\r\n\t]]></Css><Javascript><![CDATA[function render(youtubeVideo) {\r\n\t  aa_youtube_video(youtubeVideo);\r\n\t}]]></Javascript></xtml></Component></xtml><xtml ns="youtube"><Component id="YoutubeVideo" type="field.Fields" execution="native"><Param name="Title" titleField="true"/><Param name="YoutubeKey" description="E.g. LxtUTDK5mWA"/><Param name="Style" type="youtube.Style"><Default t="youtube_style.Default"/></Param><Param name="FieldAspect" type="field.FieldAspect[]" light="false" script="true"/><Param name="ID" essential="true" idField="true"/></Component></xtml><xtml ns="yesno"><Component id="IsEmpty" type="data.Boolean" execution="native"><Param name="Value" Default="%%"/><Param name="CheckInnerText" type="data.Boolean"/></Component><Component id="NotEmpty" type="data.Boolean" execution="native"><Param name="Value" Default="%%" essential="true"/><Param name="CheckInnerText" type="data.Boolean"/></Component><Component id="Contains" type="data.Boolean" execution="native"><Param name="AllText"><Default t="data.Same"/></Param><Param name="Text" type="data.Data[]" essential="true"/><Param name="IgnoreCase" type="data.Boolean"><Default value="false"/></Param><Param name="IgnoreOrder" type="data.Boolean"><Default value="false"/></Param><Param name="OneOf" type="data.Boolean"/></Component><Component id="And" type="data.Boolean" execution="native"><Param name="Item" type="data.Boolean[]" script="true" essential="true"/></Component></xtml><xtml ns="xtml"><Component id="ComponentDefinition" type="data.Data" execution="native"><Param name="ID" essential="true"/><Param name="ToXtml" type="data.Boolean"/></Component><Component id="UseParam" type="*" execution="native" dtsupport="false"><Param name="Param" essential="true"/><Param name="Input" Default="%%"/></Component><Component id="RunXtml" type="*" execution="native" dtsupport="false"><Param name="Xtml" essential="true" remark="no default (in js)"/><Param name="Input" remark="default %% in js"/><Param name="ForceInputParam" type="data.Boolean"/><Param name="Field"/><Param name="Method"/></Component><Component id="UseParamArray" type="*" execution="native" dtsupport="false"><Param name="Param" essential="true"/></Component><Component id="Params" type="data.Data" execution="native" dtsupport="false"><Param name="Param" type="data.Data[]"/><Param name="ScriptParam" type="data.Data[]"/><Param name="Method" type="data.Data[]"/><Param name="ScriptParamArray" type="data.Data[]"/></Component></xtml><xtml ns="xml"><Component id="Xml" type="data.Data" execution="native"><Param name="*" type="xml"/><Param name="DynamicContent" type="data.Boolean" Default="false"/><Param name="EncodeDynamicContent" type="data.Boolean" Default="true" description="set to false when using cdata"/></Component></xtml><xtml ns="visual_container"><Component id="MobileSkin" type="visual_container.Style"><xtml t="ui.CustomStyle"><Css><![CDATA[#this {\r\n  display: inline-block;\r\n  position: relative;\r\n  border1: 1px solid #AF9D9D;\r\n  border-radius: 5px;\r\n  background-clip: padding-box;\r\n  background-color1: #232323;\r\n  background-color: #fdfdfd;\r\n  box-shadow: 0 0 15px rgba(0,0,0,.28), inset 0 1px 1px rgba(255,255,255,.45), inset 0 0 2px rgba(255,255,255,.2);\r\n  padding: 13px;\r\n}\r\n#this>.section_body {\r\n  background:white;\r\n}\r\n#this>.section_body::-webkit-scrollbar\r\n {\r\n  width: 5px;\r\n}\r\n#this>.section_body::-webkit-scrollbar-thumb\r\n{\r\n  border-radius: 5px;\r\n  background: #BBB;\r\n}\r\n#this>.section_body::-webkit-scrollbar-track {\r\n  background: #111;\r\n}\r\n]]></Css><Html><![CDATA[<div>\r\n  <div class="section_body"/>\r\n</div>]]></Html><Javascript><![CDATA[function(section) {\r\n  aa_visualContainerStyle(section);\r\n}]]></Javascript></xtml></Component></xtml><xtml ns="uitext"><Component id="PlainText" type="uitext.Style"><xtml t="ui.CustomStyle" Html="&lt;div /&gt;" Css="#this { }"><Javascript><![CDATA[function(textObj) { \r\n  textObj.$el.html(textObj.text);\r\n}]]></Javascript><![CDATA[]]></xtml></Component></xtml><xtml ns="uiaction"><Component id="GoToPage" type="action.Action" execution="native"><Param name="Url" essential="true"/><Param name="Type" type="enum"><Default value="open in a new tab"/><value>navigate current page</value><value>open in a new tab</value></Param></Component><Component id="SetUrlFragment" type="action.Action" light="false"><Param name="Fragment"/><Param name="Attribute" essential="true"/><Param name="Value" essential="true"/><xtml t="action.IfThenElse"><If t="yesno.NotEmpty" Value="%$Fragment%"/><Then t="uiaction.GoToUrl"><Url t="data.Pipeline"><Item t="data.Url"/><Item t="text.Replace" Find="#.*" ReplaceWith="" UseRegex="true"/><Item t="text.Concat" Suffix="#%$Fragment%"/></Url></Then><Else t="uiaction.SetUrlFragment"><Fragment t="bart_url.NewUrlFragment" Proposed="?%$Attribute%=%$Value%"><Current t="ui.UrlFragment"/></Fragment></Else></xtml></Component><Component id="GoToUrl" type="action.Action" execution="native" hidden="true" light="false"><Param name="Url" essential="true"/></Component></xtml><xtml ns="ui"><Component id="CustomStyle" type="data.Data" customPT="true" execution="native"><Param name="Html" codemirror="true" light="false"/><Param name="Css" codemirror="true" light="false"/><Param name="Javascript" codemirror="true" light="false"/></Component><Component id="UrlFragment" type="data.Data"><Param name="Attribute" essential="true"/><xtml t="data.Pipeline"><Item t="data.Url"/><Item t="text.Split" Separator="#" Part="Second"/><Item t="data.IfThenElse" Then="%%"><If t="yesno.IsEmpty" Value="%$Attribute%"/><Else t="ui.UrlFragmentAttribute" Url="%%" Attribute="%$Attribute%"><Url t="data.Url"/></Else></Item><Item t="text.UrlEncoding" Type="decode"/></xtml></Component><Component id="UrlFragmentAttribute" type="data.Data" execution="native"><Param name="Url"/><Param name="Attribute"/></Component><Component id="CustomCss" type="data.Data" execution="native" customPT="true"><Param name="Style" light="false"/><Param name="Css" codemirror="true" light="false"/></Component></xtml><xtml ns="text_as_item"><Component id="Default" type="text_as_item.Style"><xtml t="ui.CustomStyle"><Html><![CDATA[<div/>]]></Html><Css><![CDATA[#this { cursor: pointer; color:#333; }\r\n        #this:not(.in_table) { padding-top: 10px; clear: both; }\r\n        #this.in_table { padding:3px; } ]]></Css><Javascript><![CDATA[function (showMoreObject) {\r\n        aa_text_as_item(showMoreObject);\r\n}]]></Javascript></xtml></Component></xtml><xtml ns="text"><Component id="ToIdText" type="data.Data" execution="native"/><Component id="Replace" type="data.Data" execution="native"><Param name="Find" essential="true"/><Param name="ReplaceWith" essential="true"/><Param name="UseRegex" type="data.Boolean"><Default value="false"/></Param><Param name="ReplaceAll" type="data.Boolean"><Default value="true"/></Param><Param name="Text" Default="%%"/></Component><Component id="Concat" type="data.Aggregator" execution="native"><Param name="Items" light="false"><Default t="data.Same"/></Param><Param name="Item" light="false" type="data.Data[]"/><Param name="Separator" short="true" essential="true"/><Param name="LastSeparator" advanced="true" short="true"/><Param name="ItemText" short="true"><Default t="data.Same"/></Param><Param name="Prefix" advanced="true"/><Param name="Suffix" advanced="true"/><Param name="MaxLength" advanced="true"/><Param name="SuffixForMax" advanced="true"><Default value="..."/></Param></Component><Component id="Split" type="data.Data" execution="native"><Param name="Separator" Default=","/><Param name="Text" Default="%%"/><Param name="Part" type="enum" Default="All" Options="All,First,ButFirst,Second,By index,Last,All but Last,All but First,All but First and Last"/><Param name="Index" type="data.Data" description="Relevant only for \'By Index\' Part"/><Param name="NoEmptyValues" type="data.Boolean"/><Param name="Regex" type="data.Boolean" description="Use regular expression as a separator"/><Param name="Default" description="default result if empty value"/></Component><Component id="UrlEncoding" type="data.Data" execution="native"><Param name="Data" title="Text"/><Param name="Type" type="enum"><Default value="encode"/><value>encode</value><value>decode</value></Param></Component></xtml><xtml ns="scroll_size"><Component id="DeviceHeight" type="scroll_size.Height" execution="native"><Param name="ReduceHeightOfOtherField" Description="Use field id here"><FieldAspect t="field_dt.FieldIdParam"/></Param><Param name="ReducePixels" Description="E.g. 100 will reduce 100px" advanced="true"><FieldAspect t="field_dt.SliderParam"/></Param><Param name="ApplyOn" type="enum" Default="height" advanced="true"><value>height</value><value>min-height</value><value>max-height</value></Param><Param1 name="Percentages" Description="E.g 80%" advanced="true"><FieldAspect t="field_dt.SliderParam" Min="0" Max="100" Units="%"/></Param1><Param name="StretchFromCurrentLocation" type="data.Boolean" Default="true" advanced="true"/></Component></xtml><xtml ns="sample"><Component id="main" type="jbart.MyWidgetPage"><xtml t="control.Layout" ID="main" Title="main"><FieldAspect t="field_aspect.FieldData" FieldData="%$Data%"/><Layout t="ui.CustomCss" base="layout.Default"><Style t="layout.Default"/><Css><![CDATA[#this {} .body_top {\n  background-image:-webkit-linear-gradient(123deg, #6578da 0\\%, #435091 50\\%, #222849 100\\%);\n  background-color:#435091;\n}\n.body_top_title {\n  color:#ffffff;\n  font-size:38px;\n  padding-top:40px;\n  text-align:center;\n}\n.body_second_title {\n  color:#ffffff;\n  font-size:22px;\n  padding-top:30px;\n  text-align:center;\n}\n.body_group {\n  background:#F7F7F7;\n}\n.body_item_title {\n  font-weight:500;\n  font-size:26px;\n  color:#45494d;\n  padding-top:24px;\n  padding-left:35px;\n}\n.body_item_second_title {\n  font-style:normal;\n  font-size:16px;\n  color:#45494d;\n  padding-top:24px;\n  padding-left:38px;\n}]]></Css></Layout><Field t="control.Layout" ID="_Vertical_Layout" Title="Top Bar"><Layout t="ui.CustomCss" base="layout.Vertical"><Style t="layout.Vertical" Spacing="0"/><Css><![CDATA[#this {\n  height:75px;\n  background-color:#f4f7f9;\n  z-index:100;\n}]]></Css></Layout><Field t="control.Layout" ID="_Vertical_Layout2" Title="Logo"><Layout t="layout.HorizontalCss3" Spacing="7"/><Field t="field.Image" ID="_Image" Title="Image"><Image t="img.Image" Url="%$_Images%/LetMeSee/lmc_logo.png"><AdjustSize t="img.Center"/></Image><Style t="image.PlainImage"/></Field><Field t="control.Label" ID="_Label" Title="Let Me See" Text=""><Style t="ui.CustomCss" base="uitext.PlainText"><Style t="uitext.PlainText"/><Css><![CDATA[#this { height: 40px; line-height: 40px; color: ##322f31; \n  font-weight: bold; font-size: 25px; }\n]]></Css></Style></Field><FieldAspect t="field_feature.Layout"><Css><![CDATA[#this { padding-top: 17px; top: 14px; padding-left: 11px; }\n#wrapper { }\n]]></Css></FieldAspect></Field><Field t="control.Layout" ID="_Vertical_Layout3" Title="Pages"><Layout t="ui.CustomCss" base="layout.Vertical"><Style t="layout.Vertical" Spacing="0"/><Css><![CDATA[#this { position: absolute; top: 21px; left: 280px; }\n.width_mobile_phone #this { display: none; }\n]]></Css></Layout><Field t="field.ItemList" Title="items" ID="itemslist"><FieldAspect t="field_aspect.ItemListContainer"><Items t="itemlist.Items" Items="%$Pages/page%"/></FieldAspect><FieldAspect t="itemlist_aspect.ShowTextWhenNoItems"/><View t="ui.CustomCss" base="itemlist_style.Tiles"><Style t="itemlist_style.Tiles"/><Css><![CDATA[#this>*>.aa_item { float: left; margin: 0 23px 5px 0; }\n#this>.clean { clear: both; }\n]]></Css></View><Field t="control.Button" ID="_Button" Title="Page" HideTitle="true" ButtonText="%@name%"><Style t="ui.CustomCss" base="btn.Hyperlink"><Style t="btn.Hyperlink"/><Css><![CDATA[#this {\n  font-weight:600;\n  font-style:normal;\n  line-height:36px;\n  height:36px;\n  font-size:14px;\n  text-transform:uppercase;\n  color:#7b8386;\n  cursor:pointer;\n  padding-bottom:5px;\n}\n#this.selected {\n  border-bottom:2px solid #4DACF9;\n  color:#322f31; \n}\n#this:hover {\n  transition-property:all;\n  transition-duration:3.3s;\n  color:#50b1ff;\n}\n]]></Css></Style><Action t="action.RunActions"><Action t="uiaction.SetUrlFragment" Attribute="page" Value="%@id%"/><Action t="field.RefreshField" FireOnUpdate="" FieldID="main" Scope="screen"/></Action><FieldAspect t="field_feature.CssClass" AddClassTo="content" ClassName="selected"><ConditionForClass t="yesno.And"><Item value="%$PageInUrl% == %@id%"/><Var name="PageInUrl" t="ui.UrlFragment" Attribute="page"/></ConditionForClass></FieldAspect></Field></Field></Field><Field t="control.Button" ID="_Button3" Title="Mobile pages popup"><Style t="btn.MobilePagesButton"/><FieldAspect t="field_feature.Css"><Css><![CDATA[#this {\n  top:18px;\n  right:20px;\n  position:absolute;\n  display:none;\n}\n.width_mobile_phone #this {\n  display:block;\n}]]></Css></FieldAspect><Action t="popup.OpenPopup"><Style t="ui.CustomStyle" base="popup.Default"><Html><![CDATA[<div>\n <div class="aa_popup_cover" />\n <div class="aa_popup_frame">\n  <div class="aa_popup_contents" />\n </div>\n</div>]]></Html><Css><![CDATA[#this>.aa_popup_cover {\n  background:#fff;\n  opacity:0.99;\n  position:fixed;\n  left:0;\n  right:0;\n  top:0px;\n  bottom:0;\n}\n#this>.aa_popup_frame {\n  background:transparent;\n  position:absolute;\n  left:20px;\n  right:20px;\n  top:70px;\n}]]></Css><Javascript><![CDATA[function show(popup) {\n    aa_popup(popup,{\n      screenCover: true,\n      features: [\n        aa_popup_feature_closeOnEsc()\n      ]\n    });\n}]]></Javascript></Style><Contents t="field.InnerPage" Title="pages"><Layout t="layout.Default"/><Field t="field.ItemList" Title="items" ID="itemslist1"><FieldAspect t="field_aspect.ItemListContainer"><Items t="itemlist.Items" Items="%$Pages/page%"/></FieldAspect><FieldAspect t="itemlist_aspect.ShowTextWhenNoItems"/><View t="itemlist_style.Simple"/><Field t="control.Button" ID="_Button4" Title="Page" HideTitle="true" ButtonText="%@name%"><Style t="ui.CustomCss" base="btn.GreenButton"><Style t="btn.GreenButton"/><Css><![CDATA[#this {\n  width: 100\\%;\n  cursor:pointer;\n  background: #EEF3F6;\n  font: bold 13px arial;\n  text-align:center;\n  border:none;\n  margin-bottom:10px;\n  \nline-height: 36px;\nheight: 36px;\npadding: 0 10px;\ntext-transform: uppercase;\ncolor: #7b8386;  \n}\n#this:hover {\n  color: #50b1ff;\n}\n#this:active {\n}\n#this:focus {\n  outline: none;\n}\n]]></Css></Style><Action t="popup.CloseContainingPopup" ExitMode=""><DoOnExit t="action.RunActions"><Action t="uiaction.SetUrlFragment" Attribute="page" Value="%@id%"/><Action t="field.RefreshField" FireOnUpdate="" FieldID="main" Scope="screen"/></DoOnExit></Action></Field></Field></Contents></Action></Field></Field><Field t="control.Layout" ID="_body" Title="Body"><Layout t="layout.Vertical" Spacing="0"/><Field t="control.Layout" ID="_Vertical_Layout5" Title="Overview"><Layout t="layout.Vertical" Spacing="0"/><FieldAspect t="field_aspect.Hidden"><OnCondition t="field_aspect.CheckConditionForEveryItem" DataForCondition="Item data" WhenHidden="Do not render" ShowCondition="%$PageID% == \'Overview\'"/></FieldAspect><Field t="control.Layout" ID="_Vertical_Layout4" Title="Body Top"><Layout t="ui.CustomCss" base="layout.Vertical"><Style t="layout.Vertical" Spacing="0"/><Css><![CDATA[#this { height: 400px; position: relative; }\n#this >.field:not(:last-child) { margin-bottom: 0; }\n]]></Css></Layout><FieldAspect t="field_feature.CssClass" AddClassTo="content" ClassName="body_top"/><Field t="control.Label" ID="_Label1" Title="The New Way for Customer Engagement"><Style t="uitext.PlainText"/><FieldAspect t="field_feature.CssClass" AddClassTo="content" ClassName="body_top_title"/></Field><Field t="control.Label" ID="_Label1" Title="second title" Text="Mobile Personal Customer Room"><Style t="uitext.PlainText"/><FieldAspect t="field_feature.CssClass" AddClassTo="content" ClassName="body_second_title"/></Field><Field t="youtube.YoutubeVideo" ID="_YoutubeVideo" Title="YoutubeVideo" YoutubeKey="http://www.youtube.com/watch?v=iZpmakxg8u4"><Style t="youtube_style.Default" Width="266px" Height="211px"/><FieldAspect t="field_feature.Css"><Css><![CDATA[iframe { position: absolute; top: 0; left: 0; right: 0; \n  margin: auto; }\n#this { position: relative; margin-top: 16px; }\n]]></Css></FieldAspect></Field><Field t="control.Button" ID="_Button2" Title="Try it NOW"><Style t="btn.BlueButton"/><FieldAspect t="field_feature.Css"><Css><![CDATA[#this { top: 101px; right: 5%; position: absolute; }\n#wrapper { }\n]]></Css></FieldAspect><Action t="uiaction.GoToPage" Type="open in a new tab" Url="https://jb-letmesee.appspot.com/letmesee.html?newdocument=true"/></Field></Field><Field t="control.Layout" ID="_Vertical_Layout6" Title="CoBrowsing"><Layout t="ui.CustomCss" base="layout.Vertical"><Style t="layout.Vertical" Spacing="0"/><Css><![CDATA[#this { height: 498px; }\n]]></Css></Layout><FieldAspect t="field_feature.CssClass" AddClassTo="content" ClassName="body_group2"/><Field t="control.Layout" ID="_Horizontal_Layout" Title="Horizontal Layout"><Layout t="layout.Horizontal" Spacing="61" VerticalLayoutForMobileWidth="true"/><Field t="control.Layout" ID="_Group" Title="Group"><Field t="control.Label" ID="_Label3" Title="title" Text="Dynamic &amp; Personalized"><Style t="uitext.PlainText"/><FieldAspect t="field_feature.CssClass" AddClassTo="content" ClassName="body_item_title"/></Field><Layout t="layout.Default"/><Field t="control.Label" ID="_Label3" Title="title1" Text="Drag any content into the room"><Style t="uitext.PlainText"/><FieldAspect t="field_feature.CssClass" AddClassTo="content" ClassName="body_item_second_title"/></Field></Field><Field t="field.Image" ID="_Image1" Title="Image"><Image t="img.Image" Url="//letmesee2.storage.googleapis.com/e30534b6-004d-4554-b99c-d8596f5f794b_lmc_main2.png"><AdjustSize t="img.Center"/><FrameHeight t="img.FixedHeight" Height="456"/><FrameWidth t="img.FixedWidth" Width="616"/></Image><Style t="image.PlainImage"/></Field></Field></Field><Field t="control.Layout" ID="_Vertical_Layout6" Title="Continous"><Layout t="ui.CustomCss" base="layout.Vertical"><Style t="layout.Vertical" Spacing="0"/><Css><![CDATA[#this { height: 381px; }\n]]></Css></Layout><FieldAspect t="field_feature.CssClass" AddClassTo="content" ClassName="body_group"/><Field t="control.Layout" ID="_Horizontal_Layout" Title="Horizontal Layout"><Layout t="layout.HorizontalCss3" Spacing="61"/><Field t="control.Layout" ID="_Group" Title="Group"><Field t="control.Label" ID="_Label3" Title="Full Sale Cycle" Text=""><Style t="uitext.PlainText"/><FieldAspect t="field_feature.CssClass" AddClassTo="content" ClassName="body_item_title"/></Field><Layout t="layout.Default"/><Field t="control.Label" ID="_Label3" Title="title1" Text="Start with landing page or mailing lists&#xa;Build customer specific products and offers&#xa;Analyze Customer Activity to locate hot leads&#xa;Use Co-Browsing to convert customers&#xa;Invite customers to face to face meetigs&#xa;"><Style t="uitext.PlainText"/><FieldAspect t="field_feature.CssClass" AddClassTo="content" ClassName="body_item_second_title"/></Field></Field><Field t="youtube.YoutubeVideo" ID="_YoutubeVideo1" Title="YoutubeVideo" YoutubeKey="https://www.youtube.com/watch?v=CKbKTyS6O4w"><Style t="youtube_style.Default" Width="420px" Height="315px"/><FieldAspect t="field_feature.Layout"><Css><![CDATA[#wrapper {\n  margin-top: 35px;\n}\n ]]></Css></FieldAspect></Field></Field></Field></Field><Field t="control.Layout" ID="_Vertical_Layout5" Title="Personal"><Layout t="layout.Vertical" Spacing="0"/><Field t="control.Layout" ID="_Vertical_Layout4" Title="Body Top"><Layout t="ui.CustomCss" base="layout.Vertical"><Style t="layout.Vertical" Spacing="0"/><Css><![CDATA[#this { height: 400px; }\n#this >.field:not(:last-child) { margin-bottom: 0; }\n]]></Css></Layout><FieldAspect t="field_feature.CssClass" AddClassTo="content" ClassName="body_top"/><Field t="control.Label" ID="_Label1" Title="Make Fun"><Style t="uitext.PlainText"/><FieldAspect t="field_feature.CssClass" AddClassTo="content" ClassName="body_top_title"/></Field><Field t="control.Label" ID="_Label1" Title="second title" Text="Create a rich and fun minisite within minutes"><Style t="uitext.PlainText"/><FieldAspect t="field_feature.CssClass" AddClassTo="content" ClassName="body_second_title"/></Field></Field><FieldAspect t="field_aspect.Hidden"><OnCondition t="field_aspect.CheckConditionForEveryItem" DataForCondition="Item data" WhenHidden="Do not render" ShowCondition="%$PageID% == \'PersonalUsage\'"/></FieldAspect></Field><Field t="control.Layout" ID="_Vertical_Layout5" Title="Business"><Layout t="layout.Vertical" Spacing="0"/><Field t="control.Layout" ID="_Vertical_Layout4" Title="Body Top"><Layout t="ui.CustomCss" base="layout.Vertical"><Style t="layout.Vertical" Spacing="0"/><Css><![CDATA[#this { height: 400px; }\n#this >.field:not(:last-child) { margin-bottom: 0; }\n]]></Css></Layout><FieldAspect t="field_feature.CssClass" AddClassTo="content" ClassName="body_top"/><Field t="control.Label" ID="_Label1" Title="Be Productive"><Style t="uitext.PlainText"/><FieldAspect t="field_feature.CssClass" AddClassTo="content" ClassName="body_top_title"/></Field><Field t="control.Label" ID="_Label1" Title="second title" Text="Create a rich and fun minisite within minutes"><Style t="uitext.PlainText"/><FieldAspect t="field_feature.CssClass" AddClassTo="content" ClassName="body_second_title"/></Field></Field><FieldAspect t="field_aspect.Hidden"><OnCondition t="field_aspect.CheckConditionForEveryItem" DataForCondition="Item data" WhenHidden="Do not render" ShowCondition="%$PageID% == \'BusinessUsage\'"/></FieldAspect></Field><Field t="control.Layout" ID="_Vertical_Layout5" Title="Pricing"><Layout t="layout.Vertical" Spacing="0"/><Field t="control.Layout" ID="_Vertical_Layout4" Title="Body Top"><Layout t="ui.CustomCss" base="layout.Vertical"><Style t="layout.Vertical" Spacing="0"/><Css><![CDATA[#this { height: 217px; }\n#this >.field:not(:last-child) { margin-bottom: 0; }\n]]></Css></Layout><FieldAspect t="field_feature.CssClass" AddClassTo="content" ClassName="body_top"/><Field t="control.Label" ID="_Label1" Title="Select the right package for you"><Style t="ui.CustomCss" base="uitext.PlainText"><Style t="uitext.PlainText"/><Css><![CDATA[#this { text-transform: capitalize; }\n]]></Css></Style><FieldAspect t="field_feature.CssClass" AddClassTo="content" ClassName="body_top_title"/></Field><Field t="control.Label" ID="_Label1" Title="second title" Text="Personal relation via customer rooms"><Style t="ui.CustomCss" base="uitext.PlainText"><Style t="uitext.PlainText"/><Css><![CDATA[#this { text-transform: capitalize; }\n]]></Css></Style><FieldAspect t="field_feature.CssClass" AddClassTo="content" ClassName="body_second_title"/></Field></Field><FieldAspect t="field_aspect.Hidden"><OnCondition t="field_aspect.CheckConditionForEveryItem" DataForCondition="Item data" WhenHidden="Do not render" ShowCondition="%$PageID% == \'Pricing\'"/></FieldAspect><Field t="control.Layout" ID="Pricing_Top" Title="Pricing Top"><Layout t="ui.CustomCss" base="layout.Default"><Style t="layout.Default"/><Css><![CDATA[#this { width: 550px; margin: auto; padding-bottom: 23px; }\n]]></Css></Layout><Field t="control.Layout" ID="Pricing" Title="Pricing"><Layout t="ui.CustomStyle" base="layout.HorizontalCss3"><Html><![CDATA[<div><div class="field"/></div>]]></Html><Css><![CDATA[.pricing_section { position: relative; \n  border: 1px solid #cdcdcd; \n  background: white; \n  padding: 10px 10px 60px 10px; \n  height: 279px; width: 150px; }\n.pricing_header { text-align: center; \n  font-weight: bold; font-size: 16px; \n  padding-bottom: 4px; \n  border-bottom: 1px solid #dfdfdf; \n  margin-bottom: 8px; }\n.pricing_button { position: absolute; top: 130px; \n  left: 10px; right: 10px; }\n.features { position: absolute; top: 180px; left: 10px; \n  right: 10px; color: #787777; }\n.features>div { padding-bottom: 8px; }\n.price { text-align: center; color: #0e27c9; \n  font-weight: bold; font-size: 24px; \n  margin-bottom: 8px; }\n.unit { text-align: center; color: #8a8a8a; \n  font-size: 11px; margin-bottom: 15px; }\n]]></Css><Javascript><![CDATA[function(layout) {\n  aa_horizontalBoxLayout(layout,{ spacing: \'10\' });\n}]]></Javascript></Layout><Field t="control.Layout" ID="_Vertical_Layout" Title="Personal"><Layout t="layout.Vertical" Spacing="0"/><Field t="control.Label" ID="_Label" Title="Personal"><Style t="uitext.PlainText"/><FieldAspect t="field_feature.CssClass" AddClassTo="content" ClassName="pricing_header"/></Field><FieldAspect t="field_feature.CssClass" AddClassTo="content" ClassName="pricing_section"/><Field t="control.Label" ID="_Label1" Title="Free"><Style t="uitext.PlainText"/><FieldAspect t="field_feature.CssClass" AddClassTo="content" ClassName="price"/></Field><Field t="control.Hyperlink" ID="_Hyperlink" Title="Free" Target="_top"><Style t="ui.CustomCss" base="hyperlink_style.Simple"><Style t="hyperlink_style.Simple"/><Css><![CDATA[#this {\n  display: block;\n  text-decoration: none;\n  cursor: pointer;\n  text-transform:capitalize;\n  text-align: center;\n  color: #000;\n  background:#0F52BA;\n  text-transform:capitalize;\n  font-size: 13px;\n  border-radius: 2px;\n  padding-top: 0px;\n  padding-right: 25px;\n  padding-bottom: 1px;\n  padding-left: 25px;\n  margin-top: 0px;\n  margin-right: 0px;\n  margin-bottom: 0px;\n  margin-left: 0px;\n  border: 1px solid #586E9E;\n  min-width: 56px;\n  vertical-align: middle;\n  line-height: 28px;\n\n  border: 1px solid rgb(178, 184, 196);\nbox-shadow: .03em .03em .05em 0px rgba(0,0,0,0.4);\nbackground-image: -webkit-linear-gradient(-90deg, #EBF1ED 0\\% , #DADAE0 100\\% );  \n}\n#this:hover {\nbackground-image: -webkit-linear-gradient(-90deg, #DADAE0 0\\% , #EBF1ED 100\\% );\n}\n#this:active {\n  outline: 0; background-image: none; \n  background: #dbdbe1;\n}\n#this.disabled {\n  cursor: default;\n  background:#5987A8;\n  background-image:none;\n}\n]]></Css></Style><Link t="data.Pipeline"><Item value="mailto:sales@artwaresoft.com"/><Var name="Body" value="I would like to purchase LetMeSee Business package"/><Item value="%%&amp;subject=%$Subject%"/><Item value="%%&amp;body=%$Body%"/><Var name="Subject" t="text.UrlEncoding" Data="Purchasing Let Me See"/></Link><FieldAspect t="field_feature.CssClass" AddClassTo="content" ClassName="pricing_button"/></Field><Field t="control.Layout" ID="_Vertical_Layout1" Title="Features"><Layout t="layout.Vertical" Spacing="0"/><FieldAspect t="field_feature.CssClass" AddClassTo="content" ClassName="features"/><Field t="control.Label" ID="_Label2" Title="Limited to personal use only"><Style t="uitext.PlainText"/></Field></Field></Field><Field t="control.Layout" ID="_Vertical_Layout" Title="Professional"><Layout t="layout.Vertical" Spacing="0"/><Field t="control.Label" ID="_Label" Title="Business"><Style t="uitext.PlainText"/><FieldAspect t="field_feature.CssClass" AddClassTo="content" ClassName="pricing_header"/></Field><Field t="control.Label" ID="_Label1" Title="$100"><Style t="uitext.PlainText"/><FieldAspect t="field_feature.CssClass" AddClassTo="content" ClassName="price"/></Field><Field t="control.Label" ID="_Label" Title="unit" Text="seat/month"><Style t="uitext.PlainText"/><FieldAspect t="field_feature.CssClass" AddClassTo="content" ClassName="unit"/></Field><Field t="control.Hyperlink" ID="_Hyperlink" Title="Try for Free" Target="_blank"><Style t="ui.CustomCss" base="hyperlink_style.Simple"><Style t="hyperlink_style.Simple"/><Css><![CDATA[#this {\n  display: block;\n  text-decoration: none;\n  cursor: pointer;\n  text-transform:capitalize;\n  text-align: center;\n  color:White;\n  background:#0F52BA;\n  text-transform:capitalize;\n  font-size: 13px;\n  border-radius: 2px;\n  padding-top: 0px;\n  padding-right: 25px;\n  padding-bottom: 1px;\n  padding-left: 25px;\n  margin-top: 0px;\n  margin-right: 0px;\n  margin-bottom: 0px;\n  margin-left: 0px;\n  border: 1px solid #586E9E;\n  text-shadow:  0.05em -0.15em 0em #002FA7;\n  box-shadow:  .03em .03em .05em 0px rgba(0,0,0,0.4);\n  background-image: -webkit-linear-gradient(-90deg, #5987A8 0\\% , #0F52BA 100\\% );\n  min-width: 56px;\n  vertical-align: middle;\n  line-height: 28px;\n}\n#this:hover {\n  background-image: -webkit-linear-gradient(-90deg, #75B2DD 0\\% , #0F52BA 100\\% );\n}\n#this:active {\n  background:#5987A8;\n  background-image: -webkit-linear-gradient(90deg, #C04000 0\\% , #FF5A36 39\\% , white 100\\% );\n  outline: 0;\n  background-image: none;\n}\n#this.disabled {\n  cursor: default;\n  background:#5987A8;\n  background-image:none;\n}\n]]></Css></Style><Link t="data.Pipeline"><Item value="mailto:sales@artwaresoft.com"/><Var name="Body" value="I would like to purchase LetMeSee Business package"/><Item value="%%?subject=%$Subject%"/><Item value="%%&amp;body=%$Body%"/><Var name="Subject" t="text.UrlEncoding" Data="Purchasing Let Me See"/></Link><FieldAspect t="field_feature.CssClass" AddClassTo="content" ClassName="pricing_button"/></Field><FieldAspect t="field_feature.CssClass" AddClassTo="content" ClassName="pricing_section"/><Field t="control.Label" ID="_Label7" Title="Free Trial1" Text="1 month free trial program"><Style t="ui.CustomCss" base="uitext.PlainText"><Style t="uitext.PlainText"/><Css><![CDATA[#this { bottom: 12px; position: absolute; \n  font-style: italic; font-weight: bold; }\n]]></Css></Style></Field><Field t="control.Label" ID="_Label" Title="Features1" Text="* Unlimited Agents&#xa;* Unlimited Usage&#xa;"><Style t="ui.CustomCss" base="uitext.PlainText"><Style t="uitext.PlainText"/><Css><![CDATA[#this {\n  line-height:25px;\n  margin-top:85px;\n  color: #787777;\n}]]></Css></Style></Field></Field><Field t="control.Layout" ID="_Vertical_Layout" Title="Professional1"><Layout t="ui.CustomCss" base="layout.Vertical"><Style t="layout.Vertical" Spacing="0"/><Css><![CDATA[#this {\n  position:relative;\n  opacity:1;\n  background:red;\n}\n#this >.field:not(:last-child) {\n  margin-bottom:0;\n}]]></Css></Layout><Field t="control.Label" ID="_Label" Title="Business Pro"><Style t="uitext.PlainText"/><FieldAspect t="field_feature.CssClass" AddClassTo="content" ClassName="pricing_header"/></Field><Field t="control.Label" ID="_Label1" Title="$200"><Style t="uitext.PlainText"/><FieldAspect t="field_feature.CssClass" AddClassTo="content" ClassName="price"/></Field><Field t="control.Label" ID="_Label" Title="unit" Text="seat/month"><Style t="uitext.PlainText"/><FieldAspect t="field_feature.CssClass" AddClassTo="content" ClassName="unit"/></Field><Field t="control.Hyperlink" ID="_Hyperlink" Title="Try for Free" Target="_blank"><Style t="ui.CustomCss" base="hyperlink_style.Simple"><Style t="hyperlink_style.Simple"/><Css><![CDATA[#this {\n  display: block;\n  text-decoration: none;\n  cursor: pointer;\n  text-transform:capitalize;\n  text-align: center;\n  color:White;\n  background:#0F52BA;\n  text-transform:capitalize;\n  font-size: 13px;\n  border-radius: 2px;\n  padding-top: 0px;\n  padding-right: 25px;\n  padding-bottom: 1px;\n  padding-left: 25px;\n  margin-top: 0px;\n  margin-right: 0px;\n  margin-bottom: 0px;\n  margin-left: 0px;\n  border: 1px solid #586E9E;\n  text-shadow:  0.05em -0.15em 0em #002FA7;\n  box-shadow:  .03em .03em .05em 0px rgba(0,0,0,0.4);\n  background-image: -webkit-linear-gradient(-90deg, #5987A8 0\\% , #0F52BA 100\\% );\n  min-width: 56px;\n  vertical-align: middle;\n  line-height: 28px;\n}\n#this:hover {\n  background-image: -webkit-linear-gradient(-90deg, #75B2DD 0\\% , #0F52BA 100\\% );\n}\n#this:active {\n  background:#5987A8;\n  background-image: -webkit-linear-gradient(90deg, #C04000 0\\% , #FF5A36 39\\% , white 100\\% );\n  outline: 0;\n  background-image: none;\n}\n#this.disabled {\n  cursor: default;\n  background:#5987A8;\n  background-image:none;\n}\n]]></Css></Style><Link t="data.Pipeline"><Item value="mailto:sales@artwaresoft.com"/><Var name="Body" value="I would like to purchase LetMeSee Business package"/><Item value="%%?subject=%$Subject%"/><Item value="%%&amp;body=%$Body%"/><Var name="Subject" t="text.UrlEncoding" Data="Purchasing Let Me See"/></Link><FieldAspect t="field_feature.CssClass" AddClassTo="content" ClassName="pricing_button"/></Field><FieldAspect t="field_feature.CssClass" AddClassTo="content" ClassName="pricing_section"/><Field t="control.Layout" ID="_Vertical_Layout1" Title="Features"><Layout t="layout.Vertical" Spacing="0"/><FieldAspect t="field_feature.CssClass" AddClassTo="content" ClassName="features"/><Field t="control.Label" ID="_Label" Title="Features" Text="* CRM Integration&#xa;* Call Center Support&#xa;"><Style t="ui.CustomCss" base="uitext.PlainText"><Style t="uitext.PlainText"/><Css><![CDATA[#this {\nline-height:25px;\n}]]></Css></Style></Field></Field><Field t="control.Label" ID="_Label7" Title="Free Trial" Text="1 month free trial program"><Style t="ui.CustomCss" base="uitext.PlainText"><Style t="uitext.PlainText"/><Css><![CDATA[#this { bottom: 12px; position: absolute; \n  font-style: italic; font-weight: bold; }\n]]></Css></Style></Field><FieldAspect t="field_feature.Css"><Css><![CDATA[#this {} #wrapper {}]]></Css></FieldAspect></Field></Field><FieldAspect t="field_feature.Css"><Css><![CDATA[#this { }\n#wrapper { margin-top: 25px; }\n]]></Css></FieldAspect></Field><FieldAspect t="field_aspect.DynamicSize"><Height t="scroll_size.DeviceHeight" ReduceHeightOfOtherField="_footer"/></FieldAspect></Field><Field t="control.Layout" ID="_Vertical_Layout5" Title="About Us"><Layout t="layout.Vertical" Spacing="0"/><Field t="control.Layout" ID="_Vertical_Layout4" Title="Body Top"><Layout t="ui.CustomCss" base="layout.Vertical"><Style t="layout.Vertical" Spacing="0"/><Css><![CDATA[#this { height: 400px; }\n#this >.field:not(:last-child) { margin-bottom: 0; }\n]]></Css></Layout><FieldAspect t="field_feature.CssClass" AddClassTo="content" ClassName="body_top"/><Field t="control.Layout" ID="_Group2" Title="Group"><Layout t="ui.CustomCss" base="layout.Default"><Style t="layout.Default"/><Css><![CDATA[#this {\n  text-align:center;\n  display:block;\n  padding-top:23px;\n}]]></Css></Layout><Field t="control.Label" ID="_Label5" Title="Label" Text="Artware"><Style t="ui.CustomCss" base="uitext.PlainText"><Style t="uitext.PlainText"/><Css><![CDATA[#this { color: #FFF; \n  font-family: Paprika, times new roman; \n  text-align: center; font-size: 30px; \n  display: inline-block; padding-top: 14px; }\n@font-face { font-family: \'Paprika\'; \n  font-style: normal; font-weight: 400; \n  src: local(\'Paprika\'), local(\'Paprika-Regular\'), url(http://themes.googleusercontent.com/static/fonts/paprika/v2/5wID_eLdfLKUwzhIdMBadA.woff) format(\'woff\'); }\n]]></Css></Style></Field></Field><Field t="control.Label" ID="_Label1" Title="second title" Text="The New Way for Customer Engagement"><Style t="uitext.PlainText"/><FieldAspect t="field_feature.CssClass" AddClassTo="content" ClassName="body_second_title"/></Field><Field t="control.Layout" ID="_Group1" Title="Group"><Field t="control.Label" ID="_Label4" Title="Label" Text="Artware is a technology company developing state of the art tools for web user experience and real time engagement. Its technology is commercially deployed worldwide, serving a customer base which includes financial institutes,  software, government, and telco.&#xa;&#xa;Artware\'s leading product is jBart. jBart Studio is a visual online tool to build web widgets. The resulting widgets are embeddable in any website, web application, or mobile web app."><Style t="ui.CustomStyle" base="uitext.PlainText"><Html><![CDATA[<div />]]></Html><Css><![CDATA[#this { color: #FFF; font-size: 16px; margin-top: 30px; \n  margin-left: 34px; max-width: 640px; \n  margin: 0 auto; text-align: justify; \n  padding-top: 10px; }\n]]></Css><Javascript><![CDATA[function(textObj) { \r\n  textObj.$el.html(textObj.text);\r\n}]]></Javascript></Style><FieldAspect t="field_feature.Layout"><Css><![CDATA[#this {\n}\n#wrapper {\n  margin-top:18px;\n}]]></Css></FieldAspect></Field><Layout t="ui.CustomCss" base="layout.Default"><Style t="layout.Default"/><Css><![CDATA[#this {}]]></Css></Layout></Field></Field><FieldAspect t="field_aspect.Hidden"><OnCondition t="field_aspect.CheckConditionForEveryItem" DataForCondition="Item data" WhenHidden="Do not render" ShowCondition="%$PageID% == \'About\'"/></FieldAspect><Field t="control.Layout" ID="_Vertical_Layout7" Title="Vertical Layout"><Layout t="layout.Vertical" Spacing="0"/><FieldAspect t="field_aspect.DynamicSize"><Height t="scroll_size.DeviceHeight" ReduceHeightOfOtherField="" StretchFromCurrentLocation="true" ReducePixels="60px" ApplyOn="height"/></FieldAspect></Field></Field><FieldAspect t="field_aspect.Variable" VarName="PageID"><Value t="ui.UrlFragment" Attribute="page"/></FieldAspect></Field><Field t="control.Page" ID="_Link_to_page" Title="Footer"><Page t="sample.Footer"/></Field><FieldAspect t="field_aspect.PagePreviewSize"><Style t="visual_container.MobileSkin"/><Size t="preview_device.Desktop"/></FieldAspect><FieldAspect t="async.AsyncActionBeforeLoad" ShowLoadingTextInStudio=""><LoadingStyle t="loading_style.Default" Height="100px"/><Action t="uiaction.SetUrlFragment" Attribute="page" Value="Overview"><Condition t="yesno.IsEmpty"><Value t="ui.UrlFragment" Attribute="page"/></Condition></Action></FieldAspect></xtml></Component><Component id="Footer" type="jbart.MyWidgetPage"><xtml t="control.Layout" ID="_footer" Title="Footer"><Layout t="ui.CustomCss" base="layout.Vertical"><Style t="layout.Vertical" Spacing="0"/><Css><![CDATA[#this {\n  background-color: #322F31;\n  height: 59px;\n  position: relative;\n}]]></Css></Layout><Field t="control.Layout" ID="_Vertical_Layout2" Title="Footer Logo"><Layout t="layout.HorizontalCss3" Spacing="7"/><Field t="field.Image" ID="_Image" Title="Image"><Image t="img.Image" Url="%$_Images%/LetMeSee/favicon2.png"><AdjustSize t="img.Center"/></Image><Style t="image.PlainImage"/></Field><Field t="control.Label" ID="_LMC_Label" Title="Let Me See"><Style t="ui.CustomCss" base="uitext.PlainText"><Style t="uitext.PlainText"/><Css><![CDATA[#this {\n  color:#e3d5dd;\n  font-size:16px;\n}]]></Css></Style></Field><FieldAspect t="field_feature.Layout"><Css><![CDATA[#this {\n  padding-top:19px;\n  padding-left:37px;\n}\n#wrapper {\n}]]></Css></FieldAspect></Field><Field t="control.Label" ID="_Label6" Title="Label" Text="Copyright 2014 - ArtwareSoft.com"><Style t="ui.CustomCss" base="uitext.PlainText"><Style t="uitext.PlainText"/><Css><![CDATA[#this {\n  text-align:center;\n  color:#e3d5dd;\n  display:inline-block;\n  margin:0 auto;\n  width:100\\%;\n  position:absolute;\n  top:20px;\n}]]></Css></Style></Field><Field t="control.Button" ID="_Button1" Title="Terms of service"><Style t="ui.CustomCss" base="btn.Hyperlink"><Style t="btn.Hyperlink"/><Css><![CDATA[#this {\n  cursor:pointer;\n  font-family:"lucida grande", tahoma;\n  color:#d1d1d1;\n  font-size:11px;\n  text-decoration:none;\n  position:absolute;\n  top:20px;\n  right:27px;\n}\n#this:hover {\n  text-decoration:underline;\n}]]></Css></Style><Action t="action.RunActions"><Action t="uiaction.GoToPage" Type="open in a new tab" Url="https://docs.google.com/document/d/159d993wZqgWtLloh4xVITTFixfxusD5_L0VJQNRVraw/pub"/></Action></Field></xtml></Component></xtml><xtml ns="preview_device"><Component id="CustomSize" type="preview_device.Size" autoexpand="true"><Param name="Width" slider="true"><FieldAspect t="field_feature.HandleEvent"><Event t="field_feature.Update"/><Action t="gstudio.Refresh"/></FieldAspect></Param><Param name="Height" slider="true"><FieldAspect t="field_feature.HandleEvent"><Event t="field_feature.Update"/><Action t="gstudio.Refresh"/></FieldAspect></Param><xtml t="object.Object"><TextProperty name="Width" value="%$Width%"/><TextProperty name="Height" value="%$Height%"/></xtml></Component><Component id="Desktop" type="preview_device.Size"><xtml t="preview_device.CustomSize" Width="1300" Height=""/></Component></xtml><xtml ns="popup"><Component id="OpenPopup" type="action.Action" execution="native"><Param name="Contents" type="ui.Page"/><Param name="PopupTitle"/><Param name="Style" type="popup.Style"><Default t="popup.Default"/></Param><Param name="Feature" type="popup.Feature[]"/></Component><Component id="Default" type="popup.Style"><xtml t="ui.CustomStyle"><Html><![CDATA[<div>\r\n <div class="aa_popup_cover" />\r\n <div class="aa_popup_frame">\r\n  <div class="aa_popup_title" />      \r\n  <div class="aa_popup_close" />\r\n  <div class="aa_popup_contents" />\r\n </div>\r\n</div>]]></Html><Css><![CDATA[\r\n#this>.aa_popup_frame {\r\n  background-color:#FFFFFF;\r\n  box-shadow: 0px 1px 4px 2px rgba(0,0,0,0.4);\r\n  min-width:100px;\r\n  min-height:150px;\r\n  border-radius:2px;\r\n}\r\n.aa_popup_title {\r\n  cursor: move;\r\n  text-align:center;\r\n  background-color:#4A617A;\r\n  font: 14px Arial;\r\n  padding-top: 7px;\r\n  padding-bottom: 7px;\r\n  border-bottom: 1px solid #A4B0BC;\r\n  color: white;\r\n  min-height: 12px;\r\n}\r\n.aa_popup_close {\r\n  cursor: pointer;\r\n  position:absolute;\r\n  background: url(\'_jbartImages_/jbart_icons.png\') no-repeat -40px 0;\r\n  width: 20px;\r\n  height: 20px;\r\n  right:4px;\r\n  top: 4px;\r\n}\r\n.aa_popup_close:hover {\r\n  background-position:-40px -20px;\r\n}\r\n#this>.aa_popup_frame>.aa_popup_contents {\r\n  padding:10px;\r\n}\r\n#this>.aa_popup_cover {\r\n  background: #929497;\r\n  opacity:0.8;\r\n  position:fixed;\r\n  left:0;\r\n  right:0;\r\n  top:0;\r\n  bottom:0;\r\n}\r\n#this>.aa_popup_frame:focus { outline: none; }\r\n]]></Css><Javascript><![CDATA[function show(popup) {\r\n    aa_popup(popup,{\r\n      screenCover: true,\r\n      features: [\r\n        aa_popup_title_dragAndDrop(),\r\n        aa_popup_feature_closeOnEsc(),\r\n        aa_popup_feature_autoFocus()        \r\n      ]\r\n    });\r\n}]]></Javascript></xtml></Component><Component id="CloseContainingPopup" type="action.Action" execution="native"><Param name="ExitMode" type="enum" Options="OK,Cancel"/><Param name="DoOnExit" type="action.Action" description="Run after validations have passed"/></Component></xtml><xtml ns="object"><Component id="SetProperty" type="action.Action" execution="native"><Param name="Object" Default="%%"/><Param name="Property" essential="true"/><Param name="Value" essential="true"/><Param name="IsSingleProperty" type="data.Boolean"/></Component><Component id="Object" type="data.Data" execution="native"><Param name="Property" type="data.Data[]" has_name="true"/><Param name="TextProperty" type="data.Data[]" has_name="true"/><Param name="BooleanProperty" type="data.Data[]" has_name="true"/><Param name="IntegerProperty" type="data.Data[]" has_name="true"/><Param name="Method" type="action.Action[]" has_name="true"/></Component><Component id="Object" type="data.Data" execution="native"><Param name="Property" type="data.Data[]" has_name="true"/><Param name="TextProperty" type="data.Data[]" has_name="true"/><Param name="BooleanProperty" type="data.Data[]" has_name="true"/><Param name="IntegerProperty" type="data.Data[]" has_name="true"/><Param name="Method" type="action.Action[]" has_name="true"/></Component></xtml><xtml ns="loading_style"><Component id="Default" type="loading_style.Style"><Param name="Height" Default="100px" slider="true" sliderUnit="px"/><xtml t="ui.CustomStyle"><Html><![CDATA[<div/>]]></Html><Css><![CDATA[#this { font-style: italic; height: %$Height%; }]]></Css><Javascript><![CDATA[function(elem) { elem.$el.html(elem.text); }]]></Javascript></xtml></Component></xtml><xtml ns="layout"><Component id="HorizontalCss3" type="layout.Style" light="false"><Param name="Spacing" Default="0" slider="true"/><xtml t="ui.CustomStyle" Spacing="%$Spacing%"><Css><![CDATA[#this {  }\r\n      #this >.field {  }]]></Css><Html><![CDATA[<div><div class="field"/></div>]]></Html><Javascript><![CDATA[function(layout) {\r\n  aa_horizontalBoxLayout(layout,{ spacing: layout.params && layout.params.Spacing });\r\n}]]></Javascript></xtml></Component><Component id="Vertical" type="layout.Style"><Param name="Spacing" Default="0"><FieldAspect t="field_dt.SliderParam"/></Param><xtml t="ui.CustomStyle"><Html><![CDATA[<div>\r\n      <div class="field"/>\r\n    </div>]]></Html><Css><![CDATA[#this {} #this >.field:not(:last-child) { margin-bottom: %$Spacing%; }\r\n    ]]></Css><Javascript><![CDATA[function(layout) {\r\n  aa_layout(layout);\r\n}]]></Javascript></xtml></Component><Component id="Default" type="layout.Style"><xtml t="ui.CustomStyle"><Css><![CDATA[#this {}]]></Css><Html><![CDATA[<div><div class="field"/></div>]]></Html><Javascript><![CDATA[function(layout) {\r\n  aa_layout(layout);\r\n}]]></Javascript></xtml></Component><Component id="Horizontal" type="layout.Style"><Param name="Spacing" Default="0" slider="true"/><Param name="VerticalLayoutForMobileWidth" type="data.Boolean" Default="false"/><xtml t="ui.CustomStyle" Spacing="%$Spacing%" VerticalLayoutForMobileWidth="%$VerticalLayoutForMobileWidth%"><Css><![CDATA[#this { }\r\n      #this >.field { }]]></Css><Html><![CDATA[<div><div class="field"/></div>]]></Html><Javascript><![CDATA[function(layout) {\r\n  var spacing = layout.params.Spacing;\r\n  aa_horizontalBoxLayout(layout,{ spacing: spacing, verticalForMobileWidth: layout.params.VerticalLayoutForMobileWidth == \'true\' });\r\n}]]></Javascript></xtml></Component></xtml><xtml ns="jbart_resource"><Component id="Data" type="bart_resource.Resources" execution="native" summaryLabel="%@ResourceID%"><Param name="ResourceID"><Field t="field.Field" FieldData="%!@ResourceID%" Title="ID" ID="ResourceID"><FieldAspect t="field_aspect.Mandatory"/></Field></Param><Param name="ValueType" type="enum" Options="xml,json,javascript,xml multiple,json to xml,calculated" Default="xml"><FieldAspect t="field_aspect.RefreshDependentFields" FieldsIds="DataResource_Value" RefreshScope="screen"/></Param><Param name="Value"><Field t="bart_dt.DataResourceValue"/></Param><Param name="CacheIn" type="bart_resource.CacheIn" script="true"/><Param name="DataSource" type="bart_resource.DataSource"/><Param name="_FillDataSource" remark="dt only"><Field t="bart_dt.FillDataSourceForXmlResource"/></Param><Param name="AutoSaveSampleData" type="enum" Options="true,false" description="Relevant only for xml. The design time will auto save changes to this resource"/></Component></xtml><xtml ns="jbart"><Component id="Widget" type="jbart.Widget" description="The component that defines the widget"><Param name="MainPage" type="jbart.MyWidgetPage"/><Param name="DataResource" type="jbart.DataResource[]" light="false"/><Param name="ApplicationFeature" type="jbart.ApplicationFeature[]"/><xtml t="action.RunActions" Comment="Do nothing"/></Component><Component id="TextboxCss" type="data.Data"><xtml t="data.FirstSucceeding"><Item><![CDATA[\r\n         #this { border:1px solid #BDC7D8; font-size:11px; padding:3px; height: 16px; width: 150px;background:url(%$_Images%/css/shadow2.png) repeat-x scroll 0 0 transparent;} \r\n         #this.readonly { border:none !important; }\r\n         #this.selected { background: #D9E8FB !important}\r\n        ]]></Item></xtml></Component></xtml><xtml ns="itemlist_style"><Component id="Tiles" type="itemlist_style.View"><xtml t="ui.CustomStyle" base="itemlist_style.Simple"><Html><![CDATA[<div>\r\n  <div class="parent">\r\n    <div class="aa_item"/>\r\n  </div>\r\n  <div class="clean" />\r\n</div>]]></Html><Css><![CDATA[#this>*>.aa_item {\r\n  float:left;\r\n  margin:0 5px 5px 0;\r\n}\r\n#this>.clean {\r\n  clear:both;\r\n}\r\n]]></Css><Javascript><![CDATA[function(itemlist) {\r\n  aa_itemlist(itemlist);\r\n}]]></Javascript></xtml></Component><Component id="Simple" type="itemlist_style.View"><xtml t="ui.CustomStyle"><Html><![CDATA[<div><div class="aa_item"/></div>]]></Html><Javascript><![CDATA[function(itemlist) {\r\n       aa_itemlist(itemlist);\r\n}]]></Javascript><Css><![CDATA[#this>.aa_item {} #this{}]]></Css></xtml></Component></xtml><xtml ns="itemlist_aspect"><Component id="ShowTextWhenNoItems" type="field.FieldAspect" description="Shows a text in the table when there are no items" execution="native" context="FieldComponent=field.ItemList"><Param name="Text" Default="No items available"/><Param name="Style" type="text_as_item.Style"><Default t="text_as_item.Default"/></Param></Component></xtml><xtml ns="itemlist"><Component id="Items" type="itemlist.Items" autoexpand="true"><Param name="Items"/><xtml value="%$Items%"/></Component></xtml><xtml ns="img"><Component id="FixedHeight" type="img.Height" execution="native"><Param name="Height" slider="true"/></Component><Component id="Image" type="img.Image" execution="native"><Param name="Url"/><Param name="OriginalWidth"/><Param name="OriginalHeight"/><Param name="FrameWidth" type="img.Width"/><Param name="FrameHeight" type="img.Height"/><Param name="AdjustSize" type="img.AdjustSize"><Default t="img.Center"/></Param></Component><Component id="FixedWidth" type="img.Width" execution="native"><Param name="Width" slider="true" sliderUnit=""/><xtml value="%$Width%"/></Component><Component id="Center" type="img.AdjustSize" execution="native"/></xtml><xtml ns="image"><Component id="PlainImage" type="image.Style"><xtml t="ui.CustomStyle"><Html><![CDATA[<div/>]]></Html><Css><![CDATA[#this {}]]></Css><Javascript><![CDATA[function(image) {\r\n  aa_setImage(image.el,image.image);\r\n}]]></Javascript></xtml></Component></xtml><xtml ns="hyperlink_style"><Component id="Simple" type="hyperlink_style.Style"><xtml t="ui.CustomStyle" Border="%$Border%"><Html><![CDATA[<a />]]></Html><Css><![CDATA[#this {\r\n}]]></Css><Javascript><![CDATA[function render(link) { \r\n  link.$el.text(link.title).attr(\'href\',link.link).attr(\'title\',link.tooltip).attr(\'target\',link.target);\r\n}]]></Javascript></xtml></Component></xtml><xtml ns="gstudio"><Component id="CurrentPageXtml" type="data.Data"><xtml t="data.Pipeline"><Item value="%$_JBartStudio/CurrentPage%"/><Item t="xtml.ComponentDefinition" ToXtml="true"><ID t="data.IfThenElse" Then="%%" Else="sample.%%"><If t="yesno.Contains"><Text value="."/></If></ID></Item></xtml></Component></xtml><xtml ns="field_feature"><Component id="Css" type="field.FieldAspect" execution="native" description="Styles (font, color, padding, borders)" promoted="true"><Param name="Css" css="true" styleTitle="Css"><FieldAspect t="field_aspect.HideTitle"/><Default><![CDATA[#this {} #wrapper {}]]></Default></Param></Component><Component id="CssClass" type="field.FieldAspect" execution="native"><Param name="ClassName"/><Param name="ConditionForClass" type="data.Boolean" script="true" Default="true"/><Param name="AddClassTo" Default="content" type="enum" Options="content,wrapper"/></Component><Component id="Layout" type="field.FieldAspect" description="padding and margin"><Param name="Css" css="true" styleTitle="Layout"><FieldAspect t="field_aspect.HideTitle"/><Default><![CDATA[#this {} #wrapper {}]]></Default></Param><xtml t="field_feature.Css" Css="%$Css%"/></Component></xtml><xtml ns="field_control"><Component id="Image" type="field.Control" image="%$_Images%/studio/bmp1616.png" execution="native" hidden="true"><Param name="Image" type="image.Image"/><Param name="Style" type="image.Style"><Default t="image.PlainImage"/></Param><Param name="DefaultImage" type="data.Data"/></Component></xtml><xtml ns="field_aspect"><Component id="ItemListContainer" type="field.FieldAspect" execution="native" context="FieldComponent=field.ItemList,FieldComponent=control.Layout" fieldImage="%$_Images%/studio/library.png"><Param name="Items" type="itemlist.Items"><Default t="itemlist.Items"/></Param></Component><Component id="CheckConditionForEveryItem" type="field_aspect.HiddenContition" execution="native"><Param name="ShowCondition" type="data.Boolean" script="true"/><Param name="DataForCondition" type="enum" Options="Item data,Field data" Default="Item data"/><Param name="WhenHidden" type="enum" Options="Do not render,Render as hidden html" Default="Do not render" Description="Render as hidden html enables future visibility"/></Component><Component id="Hidden" type="field.FieldAspect" execution="native" description="Hide or Show field on condition"><Param name="OnCondition" type="field_aspect.HiddenContition"/></Component><Component id="FieldData" type="field.FieldAspect" execution="native" description="Determines the data binding of the field item"><Param name="FieldData" script="true" essential="true"/></Component><Component id="PagePreviewSize" type="field.FieldAspect" context="pageForStudio=true"><Param name="Size" type="preview_device.Size"><FieldAspect t="field_feature.HandleEvent"><Event t="field_feature.Update"/><Action t="gstudio.Refresh"/></FieldAspect></Param><Param name="Style" type="visual_container.Style"><Default t="visual_container.MobileSkin"/><FieldAspect t="field_feature.HandleEvent"><Event t="field_feature.Update"/><Action t="gstudio.Refresh"/></FieldAspect></Param><xtml t="object.Object"><Method name="Run" t="field_aspect.VisualContainer" ID="studio_preview"><Style t="xtml.UseParam" Param="Style"/><Width t="img.FixedWidth" Width="%$Size/Width%"/><Height t="img.FixedHeight" Height="%$Size/Height%"/></Method></xtml></Component><Component id="VisualContainer" type="field.FieldAspect" execution="native"><Param name="Width" type="img.Width"/><Param name="Height" type="img.Height"/><Param name="Style" type="visual_container.Style"><Default t="visual_container.MobileSkin"/></Param><Param name="ID"/></Component><Component id="Variable" execution="native" type="field.FieldAspect" description="Defines a local variable" summaryLabel="%@VarName%"><Param name="VarName" Default="MyVar" essential="true"/><Param name="Value"/></Component><Component id="DynamicSize" type="field.FieldAspect" description="apply height and width using device dimensions" execution="native"><Param name="Height" type="scroll_size.Height"/><Param name="Width" type="scroll_size.Width"/></Component></xtml><xtml ns="field"><Component id="InnerPage" type="ui.Page" image="%$_Images%/studio/star1616.gif" dtsupport="false"><Param name="Title"/><Param name="Field" type="field.Fields[]" script="true" advanced="true" light="false"/><Param name="Layout" type="layout.Style" script="true"><Default t="layout.Default"/></Param><Param name="DesignTimeOnly"><Field t="bart_dt_custom.InnerPageButtons"/></Param><xtml t="control.Layout"><ID t="text.ToIdText" Data="%$Title%"/><Field t="xtml.UseParamArray" Param="Field"/><Layout t="xtml.UseParam" Param="Layout"/></xtml></Component><Component id="RefreshField" type="action.Action" execution="native"><Param name="FieldID" essential="true" type="dynamic_enum_multi"><Options t="data.Pipeline"><Item t="bart_dt.AllFieldIDs"/><Item value="%Options%"/><Item value="%code%"/></Options></Param><Param name="Scope" type="enum" Options="screen,sibling,table row" Default="screen"/><Param name="Transition" type="transition.Transition"/><Param name="FireOnUpdate" type="data.Boolean"/></Component><Component id="Control" type="field.Fields" execution="native" image="%$_Images%/studio/control1616.gif" deprecated="true"><Param name="ID" essential="true" advanced="always"/><Param name="Title" essential="true" autoaspects="false" titleField="true"/><Param name="HideTitle" type="data.Boolean" boolfeature="true"/><Param name="Control" type="field.Control" script="true" essential="true"/><Param name="FieldAspect" type="field.FieldAspect[]" light="false" script="true"/></Component><Component id="ItemList" type="field.Fields" execution="native" image="%$_Images%/studio/books.gif"><Param name="ID" advanced="always" essential="true" idField="true"/><Param name="Title" essential="true" autoaspects="false" titleField="true"/><Param name="View" type="itemlist_style.View"><Default t="itemlist_style.Simple"/></Param><Param name="SectionStyle" type="section.Style" description="Select a section style to make it a section"/><Param name="Field" type="field.Fields[]" script="true" light="false" essential="true"/><Param name="FieldAspect" type="field.FieldAspect[]" script="true" light="false"/></Component><Component id="Image" type="field.Fields" image="%$_Images%/studio/bmp1616.png"><Param name="Title" essential="true" autoaspects="false"><FieldAspect t="field_aspect.FieldData" FieldData="%!@Title%"/><FieldAspect t="field_dt.TitleField"/></Param><Param name="Image" type="image.Image" script="true"><Default t="img.Image"/></Param><Param name="Style" type="image.Style"><Default t="image.PlainImage"/></Param><Param name="DefaultImage" type="data.Data"/><Param name="HideTitle" boolfeature="true" type="data.Boolean"/><Param name="FieldAspect" type="field.FieldAspect[]" light="false" script="true"/><Param name="ID" essential="true"/><xtml t="field.Control" ID="%$ID%" Title="%$Title%" HideTitle="%$HideTitle%"><Control t="field_control.Image" Style="%$Style%" DefaultImage="%$DefaultImage%"><Image t="xtml.UseParam" Param="Image"/></Control><FieldAspect t="xtml.UseParamArray" Param="FieldAspect"/></xtml></Component></xtml><xtml ns="data"><Component id="Url" type="data.Data" execution="native"/><Component id="IfThenElse" type="data.Data" execution="native" dtsupport="false"><Param name="If" type="data.Boolean" script="true" essential="true"/><Param name="Then" essential="true"/><Param name="Else" essential="true"/></Component><Component id="Same" type="data.Data" execution="native" dtsupport="false"/><Component id="Pipeline" type="data.Data" execution="native" dtsupport="false"><Param name="Item" type="data.Data[]" essential="true"/><Param name="Aggregator" type="data.Aggregator[]"/></Component></xtml><xtml ns="control"><Component id="Button" type="field.Fields" execution="native" image="%$_Images%/studio/button.png"><Param name="ID" advanced="always" essential="true" idField="true"/><Param name="Title" titleField="true"/><Param name="ButtonText" script="true" advanced="true" description="Button text can be different than the title"/><Param name="Tooltip" advanced="true"/><Param name="Image" type="img.Image"/><Param name="Action" type="action.Action" script="true" essential="true"/><Param name="Style" type="btn.Style" script="true"><Default t="btn.JBart"/></Param><Param name="Disabled" type="data.Boolean.promoted"/><Param name="HideTitle" type="data.Boolean" advanced="true" Default="true"/><Param name="FieldAspect" type="field.FieldAspect[]" light="false" script="true"/></Component><Component id="Layout" type="field.Fields" execution="native" image="%$_Images%/studio/cube1616.gif"><Param name="Title" titleField="true"/><Param name="Field" type="field.Fields[]" light="false" script="true" essential="true"/><Param name="FieldAspect" type="field.FieldAspect[]" script="true" light="false"/><Param name="Layout" type="layout.Style" script="true"><Default t="layout.Default"/></Param><Param name="SectionStyle" type="section.Style" description="Select a section style to make it a section"/><Param name="ID" idField="true"/></Component><Component id="Hyperlink" type="field.Fields" execution="native" Description="Hyperlink"><Param name="Title" titleField="true"/><Param name="Link"/><Param name="Tooltip"/><Param name="Target" type="enum" Options="_blank,_self,_parent,_top"><Default value="_blank"/></Param><Param name="Style" type="hyperlink_style.Style"><Default t="hyperlink_style.Simple"/></Param><Param name="FieldAspect" type="field.FieldAspect[]" light="false" script="true"/><Param name="ID" idField="true"/></Component><Component id="Page" type="field.Fields,ui.Page" image="%$_Images%/studio/star1616.gif"><Param name="Title"/><Param name="Page" type="jbart.MyWidgetPage" script="true"/><xtml t="xtml.UseParam" Param="Page"/></Component><Component id="Label" type="field.Fields" execution="native" image="%$_Images%/studio/text.png"><Param name="Title" titleField="true"/><Param name="Text" script="true"/><Param name="Style" type="uitext.Style"><Default t="uitext.PlainText"/></Param><Param name="FieldAspect" type="field.FieldAspect[]" light="false" script="true"/><Param name="ID" idField="true"/></Component></xtml><xtml ns="btn"><Component id="MobilePagesButton" type="btn.Style"><xtml t="ui.CustomStyle" base="btn.JBart"><Html><![CDATA[<div>\r\n  <div class="bline bline1" />\r\n  <div class="bline bline2" />\r\n  <div class="bline bline3" />\r\n</div>]]></Html><Css><![CDATA[#this {\r\n  background:transparent;\r\n  line-height:38px;\r\n  font-size:28px;\r\n  border-radius:3px;\r\n  border:1px solid #ccc9c3;\r\n  padding:0 10px;\r\n  display:block;\r\n  cursor:pointer;\r\n  width:50px;\r\n  height:40px;\r\n  box-sizing:border-box;\r\n}\r\n.bline {\r\n  border-left:1px solid #BDC3C7;\r\n  border-right:1px solid #BDC3C7;\r\n  height:5px;\r\n  background:#768186;\r\n  margin-bottom:2px;\r\n  width:25px;\r\n}\r\n.bline1 {\r\n  margin-top:10px;\r\n}\r\n]]></Css><Javascript><![CDATA[function render(button) {\r\n  button.$el.click(function(e) { \r\n  \taa_buttonRunAction(button,e);\r\n  });\r\n}\r\n]]></Javascript></xtml></Component><Component id="GreenButton" type="btn.Style"><xtml t="ui.CustomStyle"><Html><![CDATA[<button />]]></Html><Css><![CDATA[#this { \r\n  cursor: pointer; font-family: arial; text-align: center; color:White; \r\n  background:#86B300; font-weight:bold; font-size: 13px; border-radius: 6px; \r\n  padding-top: 0px; padding-right: 25px; padding-bottom: 1px; padding-left: 25px; \r\n  border: 1px solid #6A8C01; text-shadow:  0 1px 0 #668910; \r\n  box-shadow:  .03em .03em .05em 0px rgba(0,0,0,0.4); \r\n  background-image: -webkit-linear-gradient(-90deg, #86B300 0\\% , #6A8D00 100\\% ); \r\n  min-width: 56px; -webkit-border-radius: 6px; -moz-border-radius: 6px; \r\n  -khtml-border-radius: 6px; vertical-align: middle; line-height: 28px; \r\n  -moz-box-shadow: .03em .03em .05em rgba(0,0,0,0.4); \r\n  -webkit-box-shadow: .03em .03em .05em rgba(0,0,0,0.4); \r\n}\r\n#this:hover { transition: background-position 0.1s linear; }\r\n#this:active { background:#6A8C01; outline: 0; }\r\n#this.disabled { background: #666; }\r\n]]></Css><Javascript><![CDATA[function render(button) {\r\n  aa_button(button);\r\n}]]></Javascript></xtml></Component><Component id="Hyperlink" type="btn.Style"><xtml t="ui.CustomStyle"><Html><![CDATA[<span />]]></Html><Css><![CDATA[#this {\n  cursor:pointer;\n  font-family:"lucida grande", tahoma;\n  color:blue;\n  font-size:11px;\n  text-decoration:none;\n  display: inline-block;\n}\n#this:hover {\n  text-decoration:underline;\n}\n#this.disabled {\n  text-decoration:none;\n  cursor:default;\n}]]></Css><Javascript><![CDATA[function render(button) {\r\n  aa_button(button);\r\n}]]></Javascript></xtml></Component><Component id="JBart" type="btn.Style"><Param name="MinWidth" Default="60px" slider="true" sliderUnit="px"/><xtml t="ui.CustomStyle"><Html><![CDATA[<button />]]></Html><Css><![CDATA[\r\n#this { cursor: pointer; text-transform:capitalize; text-align: center; color:White; \r\n  background:#0F52BA; text-transform:capitalize; font-size: 13px; \r\n  margin:0;\r\n  border-radius: 2px; padding-top: 0px; padding-right: 25px; padding-bottom: 1px; \r\n  padding-left: 25px; border: 1px solid #586E9E; \r\n  text-shadow:  0.05em -0.15em 0em #002FA7; \r\n  box-shadow:  .03em .03em .05em 0px rgba(0,0,0,0.4); \r\n  background-image: -webkit-linear-gradient(-90deg, #5987A8 0% , #0F52BA 100% ); \r\n  min-width: %$MinWidth%; vertical-align: middle; line-height: 28px; \r\n  }\r\n#this:hover { \r\n  background-image: -webkit-linear-gradient(-90deg, #75B2DD 0% , #0F52BA 100% ); \r\n  }\r\n#this:active { background:#5987A8; \r\n  background-image: -webkit-linear-gradient(90deg, #C04000 0% , #FF5A36 39% , white 100% ); \r\n  outline: 0; background-image: none; }\r\n#this.disabled { \r\nbackground-image:none;\r\nbackground: #5987A8;\r\ncursor: default;\r\n}  \r\n]]></Css><Javascript><![CDATA[function render(button) {\r\n  aa_button(button);\r\n}]]></Javascript></xtml></Component><Component id="BlueButton" type="btn.Style"><xtml t="ui.CustomStyle"><Html><![CDATA[<button />]]></Html><Css><![CDATA[#this {\r\n  cursor: pointer;\r\n  font-family:Arial, Helvetica;\r\n  text-transform:capitalize;\r\n  text-align: center;\r\n  color:White;\r\n  background:#0F52BA;\r\n  text-transform:capitalize;\r\n  font-size: 20px;\r\n  width: 264px;\r\n  border-radius: 5px;\r\n  padding-top: 6px;\r\n  padding-bottom: 6px;\r\n  margin-top: 0px;\r\n  margin-right: 0px;\r\n  margin-bottom: 0px;\r\n  margin-left: 0px;\r\n  border-top: 1px solid #85C9F4;\r\n  border-left: 1px solid #239EEB;\r\n  border-right: 1px solid #B3DEF8;\r\n  border-bottom: 1px solid #72C1F2;\r\n  text-shadow:  0.1em 0.1em 0.1em #027BDA;\r\n  background-image: -webkit-linear-gradient(-90deg, #61BAF2 0\\% , #1C9BEB 100\\% );\r\n  min-width: 56px;\r\n  vertical-align: middle;\r\n  line-height: 28px;\r\n}\r\n#this:hover {\r\n  background:#3798C5;\r\n}\r\n#this:active {\r\n}\r\n#this.disabled {\r\n  cursor: default;\r\n  background:#5987A8;\r\n  background-image:none;\r\n}\r\n]]></Css><Javascript><![CDATA[function render(button) {\r\n  aa_button(button);\r\n}]]></Javascript></xtml></Component></xtml><xtml ns="bart_url"><Component id="NewUrlFragment" type="data.Data" execution="native"><Param name="Current"/><Param name="Proposed"/></Component><Component id="BrowserUrl" type="bart_url.UrlProvider"><Param name="OnUpdate" type="action.Action" script="true"/><xtml t="xtml.Params"><ScriptParam name="GetValue" paramVars="Attribute" t="ui.UrlFragment" Attribute="%$Attribute%"/><ScriptParam name="Clean" t="uiaction.SetUrlFragment" Fragment=""/><ScriptParam name="Update" paramVars="ValuePairs" t="action.RunActions"><Action t="uiaction.SetUrlFragment"><Fragment t="bart_url.NewUrlFragment" Proposed="%$ValuePairs%"><Current t="ui.UrlFragment"/></Fragment></Action><Action t="xtml.UseParam" Param="OnUpdate"/></ScriptParam></xtml></Component></xtml><xtml ns="async"><Component id="AsyncActionBeforeLoad" type="field.FieldAspect" execution="native"><Param name="Action" type="action.Action"/><Param name="LoadingText" Default="Loading..."/><Param name="LoadingStyle" type="loading_style.Style"><Default t="loading_style.Default"/></Param><Param name="TextForError" Default="An error has occurred..."/><Param name="ShowLoadingTextInStudio" type="data.Boolean"/></Component></xtml><xtml ns="appfeature"><Component id="Css" type="bart.ApplicationFeature,jbart.ApplicationFeature"><Param name="Css" codemirror="true"/><xtml t="object.SetProperty" Object="%$_AppContext%" Property="Css" Value="%$Css%"/></Component><Component id="Responsive" type="jbart.ApplicationFeature" execution="native"><NativeHelper name="WidthForStudio" t="data.Pipeline"><Item t="gstudio.CurrentPageXtml"/><Item value="%FieldAspect[@t = \'field_aspect.PagePreviewSize\']%"/><Item t="xtml.RunXtml" Xtml="%%" Field="Size"/><Item value="%Width%"/></NativeHelper></Component></xtml><xtml ns="action"><Component id="IfThenElse" type="action.Action" execution="native"><Param name="If" type="data.Boolean" essential="true" script="true"/><Param name="Then" type="action.Action" script="true" essential="true"/><Param name="Else" type="action.Action" script="true" essential="true"/></Component><Component id="RunActions" type="action.Action" execution="native" decorator="Action"><Param name="Action" type="action.Action[]" essential="true"/></Component></xtml><xtml ns="jbart_api"><Component id="ShowWidget" type="ui.Control" execution="native" description="Shows/embeds a jbart widget with the relevant params"><Param name="WidgetXml"/><Param name="Page"/><Param name="RunAfter" type="action.Action" script="true"/><Param name="RunAfterControlWithTimer" type="data.Boolean" Default="true"/><Param name="_Language"/><Param name="OnError" type="action.Action" script="true"/><Param name="ControlToShowInBartContext" type="ui.Control" script="true" description="used by automatic tests"/></Component></xtml><xtml ns="validation"><Component id="DefaultOld" deprecated="true"><xtml t="validation.CustomStyleOld"><Html><![CDATA[<div />]]></Html><Css><![CDATA[#this { color:red; font-weight:bold; font-size:11px; font-family: Arial; }]]></Css><CssForInput><![CDATA[#this { background: pink !important; }]]></CssForInput><Javascript><![CDATA[function (validation) {\r\n  validation.innerHTML = validation.errorText;\r\n  validation.init({ \r\n    showError: function(control,errorElement,mandatory) {\r\n       jQuery(errorElement).insertAfter(jQuery(control).parent().children().slice(-1));\r\n       if (mandatory) jQuery(errorElement).hide(); \r\n    },\r\n    showErrorSummary: function(top,summary) {\r\n      summary.setAttribute(\'tabindex\',\'1000\');\r\n      top.appendChild(summary);\r\n      summary.focus();\r\n    }\r\n  });\r\n}]]></Javascript><CssForSummary><![CDATA[#this { display:block; color:red; font-weight:bold; margin-top:2px; font-family:Arial; font-size:11px; }]]></CssForSummary></xtml></Component><Component id="CustomStyleOld"><Param name="Html" codemirror="true"/><Param name="Css" codemirror="true"/><Param name="Javascript" codemirror="true"/><Param name="CssForSummary" codemirror="true" codemirrortype="css"/><Param name="CssForInput" codemirror="true" codemirrortype="css"/><Param name="DesignTime_Save"><Field t="bart_dt.StyleSave"><ExtraAction t="xml.AddXmlChildren" Parent="%$NewXtml%"><Children t="data.Pipeline"><Item t="xml.Xml"><xtml><CssForSummary><![CDATA[%$Xtml/CssForSummary%]]></CssForSummary><CssForInput><![CDATA[%$Xtml/CssForInput%]]></CssForInput></xtml></Item><Item value="%*%"/></Children></ExtraAction></Field></Param><ParamGenerator t="action.RunActions"><Var name="Style" t="xtml.RunXtml" Xtml="%$PrevXtml%"/><Action t="bart_dt.StyleGenerator"/><Action t="action.WriteValue" To="%!@CssForSummary%" Value="%$Style/CssForSummary%"/><Action t="action.WriteValue" To="%!@CssForInput%" Value="%$Style/CssForInput%"/></ParamGenerator><xtml t="object.Object"><TextProperty name="Html" value="%$Html%"/><TextProperty name="Css" value="%$Css%"/><TextProperty name="Javascript" value="%$Javascript%"/><TextProperty name="CssForSummary" value="%$CssForSummary%"/><TextProperty name="CssForInput" value="%$CssForInput%"/></xtml></Component></xtml><xtml ns="text"><Type id="HebrewText" HebChars="אבגדהוזחטיכלמנסעפצקרשתןףךץ"/></xtml></xtml>'));

var aa_xtml_total = 69798;
;
window.jBartWidget_Let_Me_See_Site = '<file _type="jbart_project" name="Let Me See Site" id="Let_Me_See_Site" vid="1" cross_domain="true" feed=""><xtml ns="sample"><Component id="Widget" type="jbart.Widget"><xtml t="jbart.Widget"><MainPage t="sample.main"/><DataResource t="jbart_resource.Data" ResourceID="Data" ValueType="xml"><Value><![CDATA[<xml/>]]></Value></DataResource><ApplicationFeature t="appfeature.Css"><Css><![CDATA[#this { font: 12px Arial; }\r\n      #this *:focus { outline:none; }\r\n      p { margin: 0} \r\n      ]]></Css></ApplicationFeature><DataResource t="jbart_resource.Data" ResourceID="Pages" ValueType="xml" AutoSaveSampleData=""><Value t="xml.Xml"><xml><page name="Overview" id="Overview"/><page name="Pricing" id="Pricing"/><page name="About Us" id="About"/></xml></Value></DataResource><ApplicationFeature t="appfeature.Responsive"/></xtml></Component><Component id="main" type="jbart.MyWidgetPage"><xtml t="control.Layout" ID="main" Title="main"><FieldAspect t="field_aspect.FieldData" FieldData="%$Data%"/><Layout t="ui.CustomCss" base="layout.Default"><Style t="layout.Default"/><Css><![CDATA[#this {} .body_top {\n  background-image:-webkit-linear-gradient(123deg, #6578da 0\\%, #435091 50\\%, #222849 100\\%);\n  background-color:#435091;\n}\n.body_top_title {\n  color:#ffffff;\n  font-size:38px;\n  padding-top:40px;\n  text-align:center;\n}\n.body_second_title {\n  color:#ffffff;\n  font-size:22px;\n  padding-top:30px;\n  text-align:center;\n}\n.body_group {\n  background:#F7F7F7;\n}\n.body_item_title {\n  font-weight:500;\n  font-size:26px;\n  color:#45494d;\n  padding-top:24px;\n  padding-left:35px;\n}\n.body_item_second_title {\n  font-style:normal;\n  font-size:16px;\n  color:#45494d;\n  padding-top:24px;\n  padding-left:38px;\n}]]></Css></Layout><Field t="control.Layout" ID="_Vertical_Layout" Title="Top Bar"><Layout t="ui.CustomCss" base="layout.Vertical"><Style t="layout.Vertical" Spacing="0"/><Css><![CDATA[#this {\n  height:75px;\n  background-color:#f4f7f9;\n  z-index:100;\n}]]></Css></Layout><Field t="control.Layout" ID="_Vertical_Layout2" Title="Logo"><Layout t="layout.HorizontalCss3" Spacing="7"/><Field t="field.Image" ID="_Image" Title="Image"><Image t="img.Image" Url="%$_Images%/LetMeSee/lmc_logo.png"><AdjustSize t="img.Center"/></Image><Style t="image.PlainImage"/></Field><Field t="control.Label" ID="_Label" Title="Let Me See" Text=""><Style t="ui.CustomCss" base="uitext.PlainText"><Style t="uitext.PlainText"/><Css><![CDATA[#this { height: 40px; line-height: 40px; color: ##322f31; \n  font-weight: bold; font-size: 25px; }\n]]></Css></Style></Field><FieldAspect t="field_feature.Layout"><Css><![CDATA[#this { padding-top: 17px; top: 14px; padding-left: 11px; }\n#wrapper { }\n]]></Css></FieldAspect></Field><Field t="control.Layout" ID="_Vertical_Layout3" Title="Pages"><Layout t="ui.CustomCss" base="layout.Vertical"><Style t="layout.Vertical" Spacing="0"/><Css><![CDATA[#this { position: absolute; top: 21px; left: 280px; }\n.width_mobile_phone #this { display: none; }\n]]></Css></Layout><Field t="field.ItemList" Title="items" ID="itemslist"><FieldAspect t="field_aspect.ItemListContainer"><Items t="itemlist.Items" Items="%$Pages/page%"/></FieldAspect><FieldAspect t="itemlist_aspect.ShowTextWhenNoItems"/><View t="ui.CustomCss" base="itemlist_style.Tiles"><Style t="itemlist_style.Tiles"/><Css><![CDATA[#this>*>.aa_item { float: left; margin: 0 23px 5px 0; }\n#this>.clean { clear: both; }\n]]></Css></View><Field t="control.Button" ID="_Button" Title="Page" HideTitle="true" ButtonText="%@name%"><Style t="ui.CustomCss" base="btn.Hyperlink"><Style t="btn.Hyperlink"/><Css><![CDATA[#this {\n  font-weight:600;\n  font-style:normal;\n  line-height:36px;\n  height:36px;\n  font-size:14px;\n  text-transform:uppercase;\n  color:#7b8386;\n  cursor:pointer;\n  padding-bottom:5px;\n}\n#this.selected {\n  border-bottom:2px solid #4DACF9;\n  color:#322f31; \n}\n#this:hover {\n  transition-property:all;\n  transition-duration:3.3s;\n  color:#50b1ff;\n}\n]]></Css></Style><Action t="action.RunActions"><Action t="uiaction.SetUrlFragment" Attribute="page" Value="%@id%"/><Action t="field.RefreshField" FireOnUpdate="" FieldID="main" Scope="screen"/></Action><FieldAspect t="field_feature.CssClass" AddClassTo="content" ClassName="selected"><ConditionForClass t="yesno.And"><Item value="%$PageInUrl% == %@id%"/><Var name="PageInUrl" t="ui.UrlFragment" Attribute="page"/></ConditionForClass></FieldAspect></Field></Field></Field><Field t="control.Button" ID="_Button3" Title="Mobile pages popup"><Style t="btn.MobilePagesButton"/><FieldAspect t="field_feature.Css"><Css><![CDATA[#this {\n  top:18px;\n  right:20px;\n  position:absolute;\n  display:none;\n}\n.width_mobile_phone #this {\n  display:block;\n}]]></Css></FieldAspect><Action t="popup.OpenPopup"><Style t="ui.CustomStyle" base="popup.Default"><Html><![CDATA[<div>\n <div class="aa_popup_cover" />\n <div class="aa_popup_frame">\n  <div class="aa_popup_contents" />\n </div>\n</div>]]></Html><Css><![CDATA[#this>.aa_popup_cover {\n  background:#fff;\n  opacity:0.99;\n  position:fixed;\n  left:0;\n  right:0;\n  top:0px;\n  bottom:0;\n}\n#this>.aa_popup_frame {\n  background:transparent;\n  position:absolute;\n  left:20px;\n  right:20px;\n  top:70px;\n}]]></Css><Javascript><![CDATA[function show(popup) {\n    aa_popup(popup,{\n      screenCover: true,\n      features: [\n        aa_popup_feature_closeOnEsc()\n      ]\n    });\n}]]></Javascript></Style><Contents t="field.InnerPage" Title="pages"><Layout t="layout.Default"/><Field t="field.ItemList" Title="items" ID="itemslist1"><FieldAspect t="field_aspect.ItemListContainer"><Items t="itemlist.Items" Items="%$Pages/page%"/></FieldAspect><FieldAspect t="itemlist_aspect.ShowTextWhenNoItems"/><View t="itemlist_style.Simple"/><Field t="control.Button" ID="_Button4" Title="Page" HideTitle="true" ButtonText="%@name%"><Style t="ui.CustomCss" base="btn.GreenButton"><Style t="btn.GreenButton"/><Css><![CDATA[#this {\n  width: 100\\%;\n  cursor:pointer;\n  background: #EEF3F6;\n  font: bold 13px arial;\n  text-align:center;\n  border:none;\n  margin-bottom:10px;\n  \nline-height: 36px;\nheight: 36px;\npadding: 0 10px;\ntext-transform: uppercase;\ncolor: #7b8386;  \n}\n#this:hover {\n  color: #50b1ff;\n}\n#this:active {\n}\n#this:focus {\n  outline: none;\n}\n]]></Css></Style><Action t="popup.CloseContainingPopup" ExitMode=""><DoOnExit t="action.RunActions"><Action t="uiaction.SetUrlFragment" Attribute="page" Value="%@id%"/><Action t="field.RefreshField" FireOnUpdate="" FieldID="main" Scope="screen"/></DoOnExit></Action></Field></Field></Contents></Action></Field></Field><Field t="control.Layout" ID="_body" Title="Body"><Layout t="layout.Vertical" Spacing="0"/><Field t="control.Layout" ID="_Vertical_Layout5" Title="Overview"><Layout t="layout.Vertical" Spacing="0"/><FieldAspect t="field_aspect.Hidden"><OnCondition t="field_aspect.CheckConditionForEveryItem" DataForCondition="Item data" WhenHidden="Do not render" ShowCondition="%$PageID% == \'Overview\'"/></FieldAspect><Field t="control.Layout" ID="_Vertical_Layout4" Title="Body Top"><Layout t="ui.CustomCss" base="layout.Vertical"><Style t="layout.Vertical" Spacing="0"/><Css><![CDATA[#this { height: 400px; position: relative; }\n#this >.field:not(:last-child) { margin-bottom: 0; }\n]]></Css></Layout><FieldAspect t="field_feature.CssClass" AddClassTo="content" ClassName="body_top"/><Field t="control.Label" ID="_Label1" Title="The New Way for Customer Engagement"><Style t="uitext.PlainText"/><FieldAspect t="field_feature.CssClass" AddClassTo="content" ClassName="body_top_title"/></Field><Field t="control.Label" ID="_Label1" Title="second title" Text="Mobile Personal Customer Room"><Style t="uitext.PlainText"/><FieldAspect t="field_feature.CssClass" AddClassTo="content" ClassName="body_second_title"/></Field><Field t="youtube.YoutubeVideo" ID="_YoutubeVideo" Title="YoutubeVideo" YoutubeKey="http://www.youtube.com/watch?v=iZpmakxg8u4"><Style t="youtube_style.Default" Width="266px" Height="211px"/><FieldAspect t="field_feature.Css"><Css><![CDATA[iframe { position: absolute; top: 0; left: 0; right: 0; \n  margin: auto; }\n#this { position: relative; margin-top: 16px; }\n]]></Css></FieldAspect></Field><Field t="control.Button" ID="_Button2" Title="Try it NOW"><Style t="btn.BlueButton"/><FieldAspect t="field_feature.Css"><Css><![CDATA[#this { top: 101px; right: 5%; position: absolute; }\n#wrapper { }\n]]></Css></FieldAspect><Action t="uiaction.GoToPage" Type="open in a new tab" Url="https://jb-letmesee.appspot.com/letmesee.html?newdocument=true"/></Field></Field><Field t="control.Layout" ID="_Vertical_Layout6" Title="CoBrowsing"><Layout t="ui.CustomCss" base="layout.Vertical"><Style t="layout.Vertical" Spacing="0"/><Css><![CDATA[#this { height: 498px; }\n]]></Css></Layout><FieldAspect t="field_feature.CssClass" AddClassTo="content" ClassName="body_group2"/><Field t="control.Layout" ID="_Horizontal_Layout" Title="Horizontal Layout"><Layout t="layout.Horizontal" Spacing="61" VerticalLayoutForMobileWidth="true"/><Field t="control.Layout" ID="_Group" Title="Group"><Field t="control.Label" ID="_Label3" Title="title" Text="Dynamic &amp; Personalized"><Style t="uitext.PlainText"/><FieldAspect t="field_feature.CssClass" AddClassTo="content" ClassName="body_item_title"/></Field><Layout t="layout.Default"/><Field t="control.Label" ID="_Label3" Title="title1" Text="Drag any content into the room"><Style t="uitext.PlainText"/><FieldAspect t="field_feature.CssClass" AddClassTo="content" ClassName="body_item_second_title"/></Field></Field><Field t="field.Image" ID="_Image1" Title="Image"><Image t="img.Image" Url="//letmesee2.storage.googleapis.com/e30534b6-004d-4554-b99c-d8596f5f794b_lmc_main2.png"><AdjustSize t="img.Center"/><FrameHeight t="img.FixedHeight" Height="456"/><FrameWidth t="img.FixedWidth" Width="616"/></Image><Style t="image.PlainImage"/></Field></Field></Field><Field t="control.Layout" ID="_Vertical_Layout6" Title="Continous"><Layout t="ui.CustomCss" base="layout.Vertical"><Style t="layout.Vertical" Spacing="0"/><Css><![CDATA[#this { height: 381px; }\n]]></Css></Layout><FieldAspect t="field_feature.CssClass" AddClassTo="content" ClassName="body_group"/><Field t="control.Layout" ID="_Horizontal_Layout" Title="Horizontal Layout"><Layout t="layout.HorizontalCss3" Spacing="61"/><Field t="control.Layout" ID="_Group" Title="Group"><Field t="control.Label" ID="_Label3" Title="Full Sale Cycle" Text=""><Style t="uitext.PlainText"/><FieldAspect t="field_feature.CssClass" AddClassTo="content" ClassName="body_item_title"/></Field><Layout t="layout.Default"/><Field t="control.Label" ID="_Label3" Title="title1" Text="Start with landing page or mailing lists&#xa;Build customer specific products and offers&#xa;Analyze Customer Activity to locate hot leads&#xa;Use Co-Browsing to convert customers&#xa;Invite customers to face to face meetigs&#xa;"><Style t="uitext.PlainText"/><FieldAspect t="field_feature.CssClass" AddClassTo="content" ClassName="body_item_second_title"/></Field></Field><Field t="youtube.YoutubeVideo" ID="_YoutubeVideo1" Title="YoutubeVideo" YoutubeKey="https://www.youtube.com/watch?v=CKbKTyS6O4w"><Style t="youtube_style.Default" Width="420px" Height="315px"/><FieldAspect t="field_feature.Layout"><Css><![CDATA[#wrapper {\n  margin-top: 35px;\n}\n ]]></Css></FieldAspect></Field></Field></Field></Field><Field t="control.Layout" ID="_Vertical_Layout5" Title="Personal"><Layout t="layout.Vertical" Spacing="0"/><Field t="control.Layout" ID="_Vertical_Layout4" Title="Body Top"><Layout t="ui.CustomCss" base="layout.Vertical"><Style t="layout.Vertical" Spacing="0"/><Css><![CDATA[#this { height: 400px; }\n#this >.field:not(:last-child) { margin-bottom: 0; }\n]]></Css></Layout><FieldAspect t="field_feature.CssClass" AddClassTo="content" ClassName="body_top"/><Field t="control.Label" ID="_Label1" Title="Make Fun"><Style t="uitext.PlainText"/><FieldAspect t="field_feature.CssClass" AddClassTo="content" ClassName="body_top_title"/></Field><Field t="control.Label" ID="_Label1" Title="second title" Text="Create a rich and fun minisite within minutes"><Style t="uitext.PlainText"/><FieldAspect t="field_feature.CssClass" AddClassTo="content" ClassName="body_second_title"/></Field></Field><FieldAspect t="field_aspect.Hidden"><OnCondition t="field_aspect.CheckConditionForEveryItem" DataForCondition="Item data" WhenHidden="Do not render" ShowCondition="%$PageID% == \'PersonalUsage\'"/></FieldAspect></Field><Field t="control.Layout" ID="_Vertical_Layout5" Title="Business"><Layout t="layout.Vertical" Spacing="0"/><Field t="control.Layout" ID="_Vertical_Layout4" Title="Body Top"><Layout t="ui.CustomCss" base="layout.Vertical"><Style t="layout.Vertical" Spacing="0"/><Css><![CDATA[#this { height: 400px; }\n#this >.field:not(:last-child) { margin-bottom: 0; }\n]]></Css></Layout><FieldAspect t="field_feature.CssClass" AddClassTo="content" ClassName="body_top"/><Field t="control.Label" ID="_Label1" Title="Be Productive"><Style t="uitext.PlainText"/><FieldAspect t="field_feature.CssClass" AddClassTo="content" ClassName="body_top_title"/></Field><Field t="control.Label" ID="_Label1" Title="second title" Text="Create a rich and fun minisite within minutes"><Style t="uitext.PlainText"/><FieldAspect t="field_feature.CssClass" AddClassTo="content" ClassName="body_second_title"/></Field></Field><FieldAspect t="field_aspect.Hidden"><OnCondition t="field_aspect.CheckConditionForEveryItem" DataForCondition="Item data" WhenHidden="Do not render" ShowCondition="%$PageID% == \'BusinessUsage\'"/></FieldAspect></Field><Field t="control.Layout" ID="_Vertical_Layout5" Title="Pricing"><Layout t="layout.Vertical" Spacing="0"/><Field t="control.Layout" ID="_Vertical_Layout4" Title="Body Top"><Layout t="ui.CustomCss" base="layout.Vertical"><Style t="layout.Vertical" Spacing="0"/><Css><![CDATA[#this { height: 217px; }\n#this >.field:not(:last-child) { margin-bottom: 0; }\n]]></Css></Layout><FieldAspect t="field_feature.CssClass" AddClassTo="content" ClassName="body_top"/><Field t="control.Label" ID="_Label1" Title="Select the right package for you"><Style t="ui.CustomCss" base="uitext.PlainText"><Style t="uitext.PlainText"/><Css><![CDATA[#this { text-transform: capitalize; }\n]]></Css></Style><FieldAspect t="field_feature.CssClass" AddClassTo="content" ClassName="body_top_title"/></Field><Field t="control.Label" ID="_Label1" Title="second title" Text="Personal relation via customer rooms"><Style t="ui.CustomCss" base="uitext.PlainText"><Style t="uitext.PlainText"/><Css><![CDATA[#this { text-transform: capitalize; }\n]]></Css></Style><FieldAspect t="field_feature.CssClass" AddClassTo="content" ClassName="body_second_title"/></Field></Field><FieldAspect t="field_aspect.Hidden"><OnCondition t="field_aspect.CheckConditionForEveryItem" DataForCondition="Item data" WhenHidden="Do not render" ShowCondition="%$PageID% == \'Pricing\'"/></FieldAspect><Field t="control.Layout" ID="Pricing_Top" Title="Pricing Top"><Layout t="ui.CustomCss" base="layout.Default"><Style t="layout.Default"/><Css><![CDATA[#this { width: 550px; margin: auto; padding-bottom: 23px; }\n]]></Css></Layout><Field t="control.Layout" ID="Pricing" Title="Pricing"><Layout t="ui.CustomStyle" base="layout.HorizontalCss3"><Html><![CDATA[<div><div class="field"/></div>]]></Html><Css><![CDATA[.pricing_section { position: relative; \n  border: 1px solid #cdcdcd; \n  background: white; \n  padding: 10px 10px 60px 10px; \n  height: 279px; width: 150px; }\n.pricing_header { text-align: center; \n  font-weight: bold; font-size: 16px; \n  padding-bottom: 4px; \n  border-bottom: 1px solid #dfdfdf; \n  margin-bottom: 8px; }\n.pricing_button { position: absolute; top: 130px; \n  left: 10px; right: 10px; }\n.features { position: absolute; top: 180px; left: 10px; \n  right: 10px; color: #787777; }\n.features>div { padding-bottom: 8px; }\n.price { text-align: center; color: #0e27c9; \n  font-weight: bold; font-size: 24px; \n  margin-bottom: 8px; }\n.unit { text-align: center; color: #8a8a8a; \n  font-size: 11px; margin-bottom: 15px; }\n]]></Css><Javascript><![CDATA[function(layout) {\n  aa_horizontalBoxLayout(layout,{ spacing: \'10\' });\n}]]></Javascript></Layout><Field t="control.Layout" ID="_Vertical_Layout" Title="Personal"><Layout t="layout.Vertical" Spacing="0"/><Field t="control.Label" ID="_Label" Title="Personal"><Style t="uitext.PlainText"/><FieldAspect t="field_feature.CssClass" AddClassTo="content" ClassName="pricing_header"/></Field><FieldAspect t="field_feature.CssClass" AddClassTo="content" ClassName="pricing_section"/><Field t="control.Label" ID="_Label1" Title="Free"><Style t="uitext.PlainText"/><FieldAspect t="field_feature.CssClass" AddClassTo="content" ClassName="price"/></Field><Field t="control.Hyperlink" ID="_Hyperlink" Title="Free" Target="_top"><Style t="ui.CustomCss" base="hyperlink_style.Simple"><Style t="hyperlink_style.Simple"/><Css><![CDATA[#this {\n  display: block;\n  text-decoration: none;\n  cursor: pointer;\n  text-transform:capitalize;\n  text-align: center;\n  color: #000;\n  background:#0F52BA;\n  text-transform:capitalize;\n  font-size: 13px;\n  border-radius: 2px;\n  padding-top: 0px;\n  padding-right: 25px;\n  padding-bottom: 1px;\n  padding-left: 25px;\n  margin-top: 0px;\n  margin-right: 0px;\n  margin-bottom: 0px;\n  margin-left: 0px;\n  border: 1px solid #586E9E;\n  min-width: 56px;\n  vertical-align: middle;\n  line-height: 28px;\n\n  border: 1px solid rgb(178, 184, 196);\nbox-shadow: .03em .03em .05em 0px rgba(0,0,0,0.4);\nbackground-image: -webkit-linear-gradient(-90deg, #EBF1ED 0\\% , #DADAE0 100\\% );  \n}\n#this:hover {\nbackground-image: -webkit-linear-gradient(-90deg, #DADAE0 0\\% , #EBF1ED 100\\% );\n}\n#this:active {\n  outline: 0; background-image: none; \n  background: #dbdbe1;\n}\n#this.disabled {\n  cursor: default;\n  background:#5987A8;\n  background-image:none;\n}\n]]></Css></Style><Link t="data.Pipeline"><Item value="mailto:sales@artwaresoft.com"/><Var name="Body" value="I would like to purchase LetMeSee Business package"/><Item value="%%&amp;subject=%$Subject%"/><Item value="%%&amp;body=%$Body%"/><Var name="Subject" t="text.UrlEncoding" Data="Purchasing Let Me See"/></Link><FieldAspect t="field_feature.CssClass" AddClassTo="content" ClassName="pricing_button"/></Field><Field t="control.Layout" ID="_Vertical_Layout1" Title="Features"><Layout t="layout.Vertical" Spacing="0"/><FieldAspect t="field_feature.CssClass" AddClassTo="content" ClassName="features"/><Field t="control.Label" ID="_Label2" Title="Limited to personal use only"><Style t="uitext.PlainText"/></Field></Field></Field><Field t="control.Layout" ID="_Vertical_Layout" Title="Professional"><Layout t="layout.Vertical" Spacing="0"/><Field t="control.Label" ID="_Label" Title="Business"><Style t="uitext.PlainText"/><FieldAspect t="field_feature.CssClass" AddClassTo="content" ClassName="pricing_header"/></Field><Field t="control.Label" ID="_Label1" Title="$100"><Style t="uitext.PlainText"/><FieldAspect t="field_feature.CssClass" AddClassTo="content" ClassName="price"/></Field><Field t="control.Label" ID="_Label" Title="unit" Text="seat/month"><Style t="uitext.PlainText"/><FieldAspect t="field_feature.CssClass" AddClassTo="content" ClassName="unit"/></Field><Field t="control.Hyperlink" ID="_Hyperlink" Title="Try for Free" Target="_blank"><Style t="ui.CustomCss" base="hyperlink_style.Simple"><Style t="hyperlink_style.Simple"/><Css><![CDATA[#this {\n  display: block;\n  text-decoration: none;\n  cursor: pointer;\n  text-transform:capitalize;\n  text-align: center;\n  color:White;\n  background:#0F52BA;\n  text-transform:capitalize;\n  font-size: 13px;\n  border-radius: 2px;\n  padding-top: 0px;\n  padding-right: 25px;\n  padding-bottom: 1px;\n  padding-left: 25px;\n  margin-top: 0px;\n  margin-right: 0px;\n  margin-bottom: 0px;\n  margin-left: 0px;\n  border: 1px solid #586E9E;\n  text-shadow:  0.05em -0.15em 0em #002FA7;\n  box-shadow:  .03em .03em .05em 0px rgba(0,0,0,0.4);\n  background-image: -webkit-linear-gradient(-90deg, #5987A8 0\\% , #0F52BA 100\\% );\n  min-width: 56px;\n  vertical-align: middle;\n  line-height: 28px;\n}\n#this:hover {\n  background-image: -webkit-linear-gradient(-90deg, #75B2DD 0\\% , #0F52BA 100\\% );\n}\n#this:active {\n  background:#5987A8;\n  background-image: -webkit-linear-gradient(90deg, #C04000 0\\% , #FF5A36 39\\% , white 100\\% );\n  outline: 0;\n  background-image: none;\n}\n#this.disabled {\n  cursor: default;\n  background:#5987A8;\n  background-image:none;\n}\n]]></Css></Style><Link t="data.Pipeline"><Item value="mailto:sales@artwaresoft.com"/><Var name="Body" value="I would like to purchase LetMeSee Business package"/><Item value="%%?subject=%$Subject%"/><Item value="%%&amp;body=%$Body%"/><Var name="Subject" t="text.UrlEncoding" Data="Purchasing Let Me See"/></Link><FieldAspect t="field_feature.CssClass" AddClassTo="content" ClassName="pricing_button"/></Field><FieldAspect t="field_feature.CssClass" AddClassTo="content" ClassName="pricing_section"/><Field t="control.Label" ID="_Label7" Title="Free Trial1" Text="1 month free trial program"><Style t="ui.CustomCss" base="uitext.PlainText"><Style t="uitext.PlainText"/><Css><![CDATA[#this { bottom: 12px; position: absolute; \n  font-style: italic; font-weight: bold; }\n]]></Css></Style></Field><Field t="control.Label" ID="_Label" Title="Features1" Text="* Unlimited Agents&#xa;* Unlimited Usage&#xa;"><Style t="ui.CustomCss" base="uitext.PlainText"><Style t="uitext.PlainText"/><Css><![CDATA[#this {\n  line-height:25px;\n  margin-top:85px;\n  color: #787777;\n}]]></Css></Style></Field></Field><Field t="control.Layout" ID="_Vertical_Layout" Title="Professional1"><Layout t="ui.CustomCss" base="layout.Vertical"><Style t="layout.Vertical" Spacing="0"/><Css><![CDATA[#this {\n  position:relative;\n  opacity:1;\n  background:red;\n}\n#this >.field:not(:last-child) {\n  margin-bottom:0;\n}]]></Css></Layout><Field t="control.Label" ID="_Label" Title="Business Pro"><Style t="uitext.PlainText"/><FieldAspect t="field_feature.CssClass" AddClassTo="content" ClassName="pricing_header"/></Field><Field t="control.Label" ID="_Label1" Title="$200"><Style t="uitext.PlainText"/><FieldAspect t="field_feature.CssClass" AddClassTo="content" ClassName="price"/></Field><Field t="control.Label" ID="_Label" Title="unit" Text="seat/month"><Style t="uitext.PlainText"/><FieldAspect t="field_feature.CssClass" AddClassTo="content" ClassName="unit"/></Field><Field t="control.Hyperlink" ID="_Hyperlink" Title="Try for Free" Target="_blank"><Style t="ui.CustomCss" base="hyperlink_style.Simple"><Style t="hyperlink_style.Simple"/><Css><![CDATA[#this {\n  display: block;\n  text-decoration: none;\n  cursor: pointer;\n  text-transform:capitalize;\n  text-align: center;\n  color:White;\n  background:#0F52BA;\n  text-transform:capitalize;\n  font-size: 13px;\n  border-radius: 2px;\n  padding-top: 0px;\n  padding-right: 25px;\n  padding-bottom: 1px;\n  padding-left: 25px;\n  margin-top: 0px;\n  margin-right: 0px;\n  margin-bottom: 0px;\n  margin-left: 0px;\n  border: 1px solid #586E9E;\n  text-shadow:  0.05em -0.15em 0em #002FA7;\n  box-shadow:  .03em .03em .05em 0px rgba(0,0,0,0.4);\n  background-image: -webkit-linear-gradient(-90deg, #5987A8 0\\% , #0F52BA 100\\% );\n  min-width: 56px;\n  vertical-align: middle;\n  line-height: 28px;\n}\n#this:hover {\n  background-image: -webkit-linear-gradient(-90deg, #75B2DD 0\\% , #0F52BA 100\\% );\n}\n#this:active {\n  background:#5987A8;\n  background-image: -webkit-linear-gradient(90deg, #C04000 0\\% , #FF5A36 39\\% , white 100\\% );\n  outline: 0;\n  background-image: none;\n}\n#this.disabled {\n  cursor: default;\n  background:#5987A8;\n  background-image:none;\n}\n]]></Css></Style><Link t="data.Pipeline"><Item value="mailto:sales@artwaresoft.com"/><Var name="Body" value="I would like to purchase LetMeSee Business package"/><Item value="%%?subject=%$Subject%"/><Item value="%%&amp;body=%$Body%"/><Var name="Subject" t="text.UrlEncoding" Data="Purchasing Let Me See"/></Link><FieldAspect t="field_feature.CssClass" AddClassTo="content" ClassName="pricing_button"/></Field><FieldAspect t="field_feature.CssClass" AddClassTo="content" ClassName="pricing_section"/><Field t="control.Layout" ID="_Vertical_Layout1" Title="Features"><Layout t="layout.Vertical" Spacing="0"/><FieldAspect t="field_feature.CssClass" AddClassTo="content" ClassName="features"/><Field t="control.Label" ID="_Label" Title="Features" Text="* CRM Integration&#xa;* Call Center Support&#xa;"><Style t="ui.CustomCss" base="uitext.PlainText"><Style t="uitext.PlainText"/><Css><![CDATA[#this {\nline-height:25px;\n}]]></Css></Style></Field></Field><Field t="control.Label" ID="_Label7" Title="Free Trial" Text="1 month free trial program"><Style t="ui.CustomCss" base="uitext.PlainText"><Style t="uitext.PlainText"/><Css><![CDATA[#this { bottom: 12px; position: absolute; \n  font-style: italic; font-weight: bold; }\n]]></Css></Style></Field><FieldAspect t="field_feature.Css"><Css><![CDATA[#this {} #wrapper {}]]></Css></FieldAspect></Field></Field><FieldAspect t="field_feature.Css"><Css><![CDATA[#this { }\n#wrapper { margin-top: 25px; }\n]]></Css></FieldAspect></Field><FieldAspect t="field_aspect.DynamicSize"><Height t="scroll_size.DeviceHeight" ReduceHeightOfOtherField="_footer"/></FieldAspect></Field><Field t="control.Layout" ID="_Vertical_Layout5" Title="About Us"><Layout t="layout.Vertical" Spacing="0"/><Field t="control.Layout" ID="_Vertical_Layout4" Title="Body Top"><Layout t="ui.CustomCss" base="layout.Vertical"><Style t="layout.Vertical" Spacing="0"/><Css><![CDATA[#this { height: 400px; }\n#this >.field:not(:last-child) { margin-bottom: 0; }\n]]></Css></Layout><FieldAspect t="field_feature.CssClass" AddClassTo="content" ClassName="body_top"/><Field t="control.Layout" ID="_Group2" Title="Group"><Layout t="ui.CustomCss" base="layout.Default"><Style t="layout.Default"/><Css><![CDATA[#this {\n  text-align:center;\n  display:block;\n  padding-top:23px;\n}]]></Css></Layout><Field t="control.Label" ID="_Label5" Title="Label" Text="Artware"><Style t="ui.CustomCss" base="uitext.PlainText"><Style t="uitext.PlainText"/><Css><![CDATA[#this { color: #FFF; \n  font-family: Paprika, times new roman; \n  text-align: center; font-size: 30px; \n  display: inline-block; padding-top: 14px; }\n@font-face { font-family: \'Paprika\'; \n  font-style: normal; font-weight: 400; \n  src: local(\'Paprika\'), local(\'Paprika-Regular\'), url(http://themes.googleusercontent.com/static/fonts/paprika/v2/5wID_eLdfLKUwzhIdMBadA.woff) format(\'woff\'); }\n]]></Css></Style></Field></Field><Field t="control.Label" ID="_Label1" Title="second title" Text="The New Way for Customer Engagement"><Style t="uitext.PlainText"/><FieldAspect t="field_feature.CssClass" AddClassTo="content" ClassName="body_second_title"/></Field><Field t="control.Layout" ID="_Group1" Title="Group"><Field t="control.Label" ID="_Label4" Title="Label" Text="Artware is a technology company developing state of the art tools for web user experience and real time engagement. Its technology is commercially deployed worldwide, serving a customer base which includes financial institutes,  software, government, and telco.&#xa;&#xa;Artware\'s leading product is jBart. jBart Studio is a visual online tool to build web widgets. The resulting widgets are embeddable in any website, web application, or mobile web app."><Style t="ui.CustomStyle" base="uitext.PlainText"><Html><![CDATA[<div />]]></Html><Css><![CDATA[#this { color: #FFF; font-size: 16px; margin-top: 30px; \n  margin-left: 34px; max-width: 640px; \n  margin: 0 auto; text-align: justify; \n  padding-top: 10px; }\n]]></Css><Javascript><![CDATA[function(textObj) { \r\n  textObj.$el.html(textObj.text);\r\n}]]></Javascript></Style><FieldAspect t="field_feature.Layout"><Css><![CDATA[#this {\n}\n#wrapper {\n  margin-top:18px;\n}]]></Css></FieldAspect></Field><Layout t="ui.CustomCss" base="layout.Default"><Style t="layout.Default"/><Css><![CDATA[#this {}]]></Css></Layout></Field></Field><FieldAspect t="field_aspect.Hidden"><OnCondition t="field_aspect.CheckConditionForEveryItem" DataForCondition="Item data" WhenHidden="Do not render" ShowCondition="%$PageID% == \'About\'"/></FieldAspect><Field t="control.Layout" ID="_Vertical_Layout7" Title="Vertical Layout"><Layout t="layout.Vertical" Spacing="0"/><FieldAspect t="field_aspect.DynamicSize"><Height t="scroll_size.DeviceHeight" ReduceHeightOfOtherField="" StretchFromCurrentLocation="true" ReducePixels="60px" ApplyOn="height"/></FieldAspect></Field></Field><FieldAspect t="field_aspect.Variable" VarName="PageID"><Value t="ui.UrlFragment" Attribute="page"/></FieldAspect></Field><Field t="control.Page" ID="_Link_to_page" Title="Footer"><Page t="sample.Footer"/></Field><FieldAspect t="field_aspect.PagePreviewSize"><Style t="visual_container.MobileSkin"/><Size t="preview_device.Desktop"/></FieldAspect><FieldAspect t="async.AsyncActionBeforeLoad" ShowLoadingTextInStudio=""><LoadingStyle t="loading_style.Default" Height="100px"/><Action t="uiaction.SetUrlFragment" Attribute="page" Value="Overview"><Condition t="yesno.IsEmpty"><Value t="ui.UrlFragment" Attribute="page"/></Condition></Action></FieldAspect></xtml></Component><Component id="Footer" type="jbart.MyWidgetPage"><xtml t="control.Layout" ID="_footer" Title="Footer"><Layout t="ui.CustomCss" base="layout.Vertical"><Style t="layout.Vertical" Spacing="0"/><Css><![CDATA[#this {\n  background-color: #322F31;\n  height: 59px;\n  position: relative;\n}]]></Css></Layout><Field t="control.Layout" ID="_Vertical_Layout2" Title="Footer Logo"><Layout t="layout.HorizontalCss3" Spacing="7"/><Field t="field.Image" ID="_Image" Title="Image"><Image t="img.Image" Url="%$_Images%/LetMeSee/favicon2.png"><AdjustSize t="img.Center"/></Image><Style t="image.PlainImage"/></Field><Field t="control.Label" ID="_LMC_Label" Title="Let Me See"><Style t="ui.CustomCss" base="uitext.PlainText"><Style t="uitext.PlainText"/><Css><![CDATA[#this {\n  color:#e3d5dd;\n  font-size:16px;\n}]]></Css></Style></Field><FieldAspect t="field_feature.Layout"><Css><![CDATA[#this {\n  padding-top:19px;\n  padding-left:37px;\n}\n#wrapper {\n}]]></Css></FieldAspect></Field><Field t="control.Label" ID="_Label6" Title="Label" Text="Copyright 2014 - ArtwareSoft.com"><Style t="ui.CustomCss" base="uitext.PlainText"><Style t="uitext.PlainText"/><Css><![CDATA[#this {\n  text-align:center;\n  color:#e3d5dd;\n  display:inline-block;\n  margin:0 auto;\n  width:100\\%;\n  position:absolute;\n  top:20px;\n}]]></Css></Style></Field><Field t="control.Button" ID="_Button1" Title="Terms of service"><Style t="ui.CustomCss" base="btn.Hyperlink"><Style t="btn.Hyperlink"/><Css><![CDATA[#this {\n  cursor:pointer;\n  font-family:"lucida grande", tahoma;\n  color:#d1d1d1;\n  font-size:11px;\n  text-decoration:none;\n  position:absolute;\n  top:20px;\n  right:27px;\n}\n#this:hover {\n  text-decoration:underline;\n}]]></Css></Style><Action t="action.RunActions"><Action t="uiaction.GoToPage" Type="open in a new tab" Url="https://docs.google.com/document/d/159d993wZqgWtLloh4xVITTFixfxusD5_L0VJQNRVraw/pub"/></Action></Field></xtml></Component></xtml><compress black_list="datefilter.DateFilterControl,field.TextFilterControl"/><embed with_data="true" dir="C:\\jbartdev\\gae\\artwaresite\\war\\"/></file>'; window.jBart = window.jBart || jBart; jBartWidgets.Let_Me_See_Site = jBart.activator(jBartWidget_Let_Me_See_Site); 
}());